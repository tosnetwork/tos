...
class PublicKeyHash {
 public:
  ...
  explicit PublicKeyHash(const tl_object_ptr<tos_api::PublicKey> &value);
  PublicKeyHash() {
  }
...
class Ed25519 {
 ...
 public:
  Ed25519(const tos_api::pub_ed25519 &obj) {
    data_ = obj.key_;
  }
  ...
  tl_object_ptr<tos_api::pub_ed25519> tl() const {
    return create_tl_object<tos_api::pub_ed25519>(data_);
  }
...
class AES {
 ...
 public:
  ...
  tl_object_ptr<tos_api::pub_aes> tl() const {
    return create_tl_object<tos_api::pub_aes>(data_);
  }
  td::Result<std::unique_ptr<Encryptor>> create_encryptor() const;
...
class Unenc {
 ...
 public:
  Unenc(const tos_api::pub_unenc &obj) {
  ...
  tl_object_ptr<tos_api::pub_unenc> tl() const {
    return create_tl_object<tos_api::pub_unenc>(data_.clone_as_buffer_slice());
  }
  td::Result<std::unique_ptr<Encryptor>> create_encryptor() const;
...
class Overlay {
 ...
 public:
  Overlay(const tos_api::pub_overlay &obj) {
  ...
  tl_object_ptr<tos_api::pub_overlay> tl() const {
    return create_tl_object<tos_api::pub_overlay>(data_.clone_as_buffer_slice());
  }
  td::Result<std::unique_ptr<Encryptor>> create_encryptor() const;
...
class PublicKey {
 private:
  class Empty {
   public:
    tl_object_ptr<tos_api::PublicKey> tl() const {
      UNREACHABLE();
    }
    td::uint32 serialized_size() const {
      UNREACHABLE();
 ...
 public:
  explicit PublicKey(const tl_object_ptr<tos_api::PublicKey> &id);
  PublicKey() {
  }
...
class Ed25519 {
 ...
 public:
  ...
  Ed25519(const tos_api::pk_ed25519 &obj) {
    data_ = obj.key_;
  }
  Ed25519(td::Bits256 id) : data_(id) {
    id.set_zero_s();
  ...
  tl_object_ptr<tos_api::pk_ed25519> tl() const {
    return create_tl_object<tos_api::pk_ed25519>(data_);
  }
  tl_object_ptr<tos_api::PublicKey> pub_tl() const;
...
class AES {
 ...
 public:
  ...
  tl_object_ptr<tos_api::pk_aes> tl() const {
    return create_tl_object<tos_api::pk_aes>(data_);
  }
  tl_object_ptr<tos_api::PublicKey> pub_tl() const {
    return create_tl_object<tos_api::pub_aes>(data_);
  }
...
class Unenc {
 ...
 public:
  Unenc(const tos_api::pk_unenc &obj) {
    data_ = td::SharedSlice{obj.data_.as_slice()};
  }
  Unenc(const Unenc &obj) {
    data_ = obj.data_.clone();
  ...
  tl_object_ptr<tos_api::pk_unenc> tl() const {
    return create_tl_object<tos_api::pk_unenc>(data_.clone_as_buffer_slice());
  }
  tl_object_ptr<tos_api::PublicKey> pub_tl() const {
    return create_tl_object<tos_api::pub_unenc>(data_.clone_as_buffer_slice());
  }
...
class Overlay {
 ...
 public:
  Overlay(const tos_api::pk_overlay &obj) {
    data_ = td::SharedSlice{obj.name_.as_slice()};
  }
  Overlay(const Overlay &obj) {
    data_ = obj.data_.clone();
  ...
  tl_object_ptr<tos_api::pk_overlay> tl() const {
    return create_tl_object<tos_api::pk_overlay>(data_.clone_as_buffer_slice());
  }
  tl_object_ptr<tos_api::PublicKey> pub_tl() const {
    return create_tl_object<tos_api::pub_overlay>(data_.clone_as_buffer_slice());
  }
...
class PrivateKey {
 private:
  class Empty {
   public:
    ...
    tl_object_ptr<tos_api::PrivateKey> tl() const {
      UNREACHABLE();
    }
    tl_object_ptr<tos_api::PublicKey> pub_tl() const {
      UNREACHABLE();
 ...
 public:
  explicit PrivateKey(const tl_object_ptr<tos_api::PrivateKey> &pk);
  template <class T>
