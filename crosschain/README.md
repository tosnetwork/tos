...
The EVM halves of these bridges target external counterparty chains (Ethereum, BNB Smart Chain, Polygon). Vendoring them does not add an execution engine to the TOS node — see [`workchain-execution-registry.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/workchain-execution-registry.md).
