...
module.exports = async function (deployer, network, accounts) {
  if (network === "development") {
    await deployer.deploy(Bridge, "Wrapped TOS Coin", "TOSCOIN", [accounts[0]]);
  }

 if (network === "goerli" || network === "bsc_testnet") {
   console.log('Deploy from ' + accounts[0]);
   await deployer.deploy(Bridge, "Wrapped TOS Coin", "TOSCOIN", ['0xeb05E1B6AC0d574eF2CF29FDf01cC0bA3D8F9Bf1',
 ...
 if (network === "eth_mainnet" || network === "bsc_mainnet") {
   await deployer.deploy(Bridge, "Wrapped TOS Coin", "TOSCOIN", ['0xC4c9bd836ab8b446519736166919e3d62491E041',
