...
The upstream code was developed by RSquad by order of the TON Foundation and is distributed under GPL-3.0. TOS preserves the upstream licenses and this attribution. The sources have been renamed to TOS semantics (identifiers, assembler mnemonics, file names, and documentation); except for the reviewed deltas below, opcodes, state layout, fee checks, quorum rules, and signed payload structures are unchanged.
