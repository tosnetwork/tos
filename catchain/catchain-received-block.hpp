...
class CatChainReceivedBlockImpl final : public CatChainReceivedBlock {
 public:
  ...
  tl_object_ptr<tos_api::catchain_block> export_tl() const override;
  tl_object_ptr<tos_api::catchain_block_dep> export_tl_dep() const override;
 ...
 public:
  void initialize(tl_object_ptr<tos_api::catchain_block> block, td::SharedSlice payload) override;

  void run() override;
  void pre_deliver(tos_api::catchain_block_data_fork &b);
  void pre_deliver(tos_api::catchain_block_data_badBlock &b);
  void pre_deliver(tos_api::catchain_block_data_nop &b);
  template <class T>
 ...
 public:
  CatChainReceivedBlockImpl(tl_object_ptr<tos_api::catchain_block> block, td::SharedSlice payload,
                            CatChainReceiver *chain);
  CatChainReceivedBlockImpl(tl_object_ptr<tos_api::catchain_block_dep> block, CatChainReceiver *chain);
...
inline td::StringBuilder &operator<<(td::StringBuilder &sb, const tos::catchain::CatChainReceivedBlockImpl &block) {
