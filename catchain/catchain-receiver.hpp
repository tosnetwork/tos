...
class CatChainReceiverImpl final : public CatChainReceiver {
 public:
  ...
  void process_query(adnl::AdnlNodeIdShort src, tos_api::catchain_getBlock query, td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::catchain_getDifference query,
                     td::Promise<td::BufferSlice> promise);
  template <class T>
  ...
  void receive_block(adnl::AdnlNodeIdShort src, tl_object_ptr<tos_api::catchain_block> block, td::BufferSlice payload);
  void receive_block_answer(adnl::AdnlNodeIdShort src, td::BufferSlice);

  CatChainReceivedBlock *create_block(tl_object_ptr<tos_api::catchain_block> block, td::SharedSlice payload) override;
  CatChainReceivedBlock *create_block(tl_object_ptr<tos_api::catchain_block_dep> block) override;

  td::Status validate_block_sync(const tl_object_ptr<tos_api::catchain_block_dep> &dep) const override;
  td::Status validate_block_sync(const tl_object_ptr<tos_api::catchain_block> &block,
  ...
  void add_block_cont(tl_object_ptr<tos_api::catchain_block> block, td::BufferSlice payload);
  void add_block_cont_2(tl_object_ptr<tos_api::catchain_block> block, td::BufferSlice payload);
  void add_block_cont_3(tl_object_ptr<tos_api::catchain_block> block, td::BufferSlice payload);
  void debug_add_fork(td::BufferSlice payload, CatChainBlockHeight height,
                      std::vector<CatChainBlockHash> deps) override;
  void debug_add_fork_cont(tl_object_ptr<tos_api::catchain_block> block, td::BufferSlice payload);
...
inline td::StringBuilder &operator<<(td::StringBuilder &sb, const tos::catchain::CatChainReceiverImpl *catchain) {
