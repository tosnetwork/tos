 ...
 public:
  class NodeCallback {
   public:
    ...
    virtual void register_self(td::actor::ActorId<tos::NodeActor> self) = 0;
  ...
  class Callback {
   public:
    ...
    virtual void on_closed(tos::Torrent torrent) = 0;
  };
  ...
  NodeActor(PeerId self_id, tos::Torrent torrent, td::unique_ptr<Callback> callback,
  ...
  void get_peers_info(td::Promise<tl_object_ptr<tos_api::storage_daemon_peerList>> promise);
