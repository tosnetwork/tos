...
class PeerActor : public td::actor::Actor {
 ...
 private:
  ...
  std::vector<tl_object_ptr<tos_api::storage_Update>> pending_update_peer_parts_;

  void process_update_peer_parts(const tl_object_ptr<tos_api::storage_Update> &update);
  ...
  td::BufferSlice create_update_query(tos::tl_object_ptr<tos::tos_api::storage_Update> update);
  ...
  void execute_add_update(tos::tos_api::storage_addUpdate &add_update, td::Promise<td::BufferSlice> promise);
  void execute_get_piece(tos::tos_api::storage_getPiece &get_piece, td::Promise<td::BufferSlice> promise);
