...
class StorageDaemonCli : public td::actor::Actor {
 public:
  ...
  td::Status execute_set_verbosity(int level) {
    auto query = create_tl_object<tos_api::storage_daemon_setVerbosity>(level);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
                 }
  ...
  td::Status execute_create(std::string path, std::string description, bool upload, bool copy, bool json) {
    ...
    auto query = create_tl_object<tos_api::storage_daemon_createTorrent>(path, description, upload, copy, 0);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_torrentFull>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 if (json) {
  ...
  td::Status execute_add_by_hash(td::Bits256 hash, std::string root_dir, bool paused, bool upload,
    ...
    if (partial) {
      priorities.push_back(create_tl_object<tos_api::storage_priorityAction_all>(0));
      for (std::string& f : partial.value()) {
        priorities.push_back(create_tl_object<tos_api::storage_priorityAction_name>(std::move(f), 1));
      }
    }
    auto query = create_tl_object<tos_api::storage_daemon_addByHash>(hash, std::move(root_dir), !paused, upload,
  ...
  td::Status execute_add_by_meta(std::string meta_file, std::string root_dir, bool paused, bool upload,
    ...
    auto query = create_tl_object<tos_api::storage_daemon_addByMeta>(std::move(meta), std::move(root_dir), !paused,
  ...
  td::Status execute_list(bool with_hashes, bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getTorrents>(0);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_torrentList>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 if (json) {
  ...
  td::Status execute_get(td::Bits256 hash, bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getTorrentFull>(hash, 0);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_torrentFull>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_get_meta(td::Bits256 hash, std::string meta_file) {
    auto query = create_tl_object<tos_api::storage_daemon_getTorrentMeta>(hash, 0);
    send_query(std::move(query),
               [SelfId = actor_id(this), meta_file](td::Result<tl_object_ptr<tos_api::storage_daemon_torrentMeta>> R) {
                 if (R.is_error()) {
                   return;
                 }
  ...
  td::Status execute_get_peers(td::Bits256 hash, bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getTorrentPeers>(hash, 0);
    send_query(
        std::move(query), [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_peerList>> R) {
          if (R.is_error()) {
            return;
          }
          if (json) {
  ...
  td::Status execute_get_pieces_info(td::Bits256 hash, bool files, td::uint64 offset,
    ...
    auto query = create_tl_object<tos_api::storage_daemon_getTorrentPiecesInfo>(hash, files ? 1 : 0, offset,
                                                                                max_pieces ? max_pieces.value() : -1);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_torrentPiecesInfo>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 if (json) {
  ...
  td::Status execute_set_active_download(td::Bits256 hash, bool active) {
    auto query = create_tl_object<tos_api::storage_daemon_setActiveDownload>(hash, active);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_set_active_upload(td::Bits256 hash, bool active) {
    auto query = create_tl_object<tos_api::storage_daemon_setActiveUpload>(hash, active);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_set_priority_all(td::Bits256 hash, td::uint8 priority) {
    auto query = create_tl_object<tos_api::storage_daemon_setFilePriorityAll>(hash, priority);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_SetPriorityStatus>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 if (R.ok()->get_id() == tos_api::storage_daemon_prioritySet::ID) {
  ...
  td::Status execute_set_priority_idx(td::Bits256 hash, td::uint64 idx, td::uint8 priority) {
    auto query = create_tl_object<tos_api::storage_daemon_setFilePriorityByIdx>(hash, idx, priority);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_SetPriorityStatus>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_set_priority_name(td::Bits256 hash, std::string name, td::uint8 priority) {
    auto query = create_tl_object<tos_api::storage_daemon_setFilePriorityByName>(hash, std::move(name), priority);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_SetPriorityStatus>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_remove(td::Bits256 hash, bool remove_files) {
    auto query = create_tl_object<tos_api::storage_daemon_removeTorrent>(hash, remove_files);
    send_query(std::move(query),
               [SelfId = actor_id(this), hash](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 td::TerminalIO::out() << "Success\n";
  ...
  td::Status execute_load_from(td::Bits256 hash, std::string meta, std::string path) {
    ...
    auto query = create_tl_object<tos_api::storage_daemon_loadFrom>(hash, std::move(meta_data), std::move(path), 0);
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_torrent>> R) {
                 if (R.is_error()) {
                   return;
                 }
  ...
  td::Status execute_get_speed_limits(bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getSpeedLimits>(0);
    send_query(std::move(query), [=, SelfId = actor_id(this)](
                                     td::Result<tl_object_ptr<tos_api::storage_daemon_speedLimits>> R) {
      if (R.is_error()) {
        return;
      }
      if (json) {
  ...
  td::Status execute_set_speed_limits(td::optional<double> download, td::optional<double> upload) {
    ...
    auto query = create_tl_object<tos_api::storage_daemon_setSpeedLimits>();
    query->flags_ = 0;
    if (download) {
      query->flags_ |= 1;
  ...
  td::Status execute_new_contract_message(td::Bits256 hash, std::string file, td::uint64 query_id,
                                          ...
                                          td::optional<td::uint32> max_span) {
    tl_object_ptr<tos_api::storage_daemon_NewContractParams> params;
    if (provider_address) {
      if (rate || max_span) {
        return td::Status::Error("Incompatible flags");
      }
      params = create_tl_object<tos_api::storage_daemon_newContractParamsAuto>(provider_address.unwrap());
    } else {
      if (!rate || !max_span) {
        return td::Status::Error("No flags are set");
      }
      params = create_tl_object<tos_api::storage_daemon_newContractParams>(rate.unwrap(), max_span.unwrap());
    }
    auto query = create_tl_object<tos_api::storage_daemon_getNewContractMessage>(hash, query_id, std::move(params));
    send_query(std::move(query), [SelfId = actor_id(this),
                                  file](td::Result<tl_object_ptr<tos_api::storage_daemon_newContractMessage>> R) {
      if (R.is_error()) {
        return;
      }
      auto obj = R.move_as_ok();
  ...
  td::Status execute_import_pk(std::string file) {
    ...
    auto query = create_tl_object<tos_api::storage_daemon_importPrivateKey>(pk.tl());
    send_query(
        std::move(query), [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_keyHash>> R) {
          if (R.is_error()) {
            return;
          }
  ...
  td::Status execute_deploy_provider() {
    auto query = create_tl_object<tos_api::storage_daemon_deployProvider>();
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_providerAddress>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 auto obj = R.move_as_ok();
                 ...
                 td::TerminalIO::out()
                     << "Send a non-bounceable message with 1 TOS to this address to initialize smart contract.\n";
                 td::actor::send_closure(SelfId, &StorageDaemonCli::command_finished, td::Status::OK());
               });
    return td::Status::OK();
  }
  ...
  td::Status execute_init_provider(std::string address) {
    auto query = create_tl_object<tos_api::storage_daemon_initProvider>(std::move(address));
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_remove_storage_provider() {
    auto query = create_tl_object<tos_api::storage_daemon_removeStorageProvider>();
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_get_provider_params(std::string address, bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getProviderParams>(address);
    send_query(std::move(query), [=, SelfId = actor_id(this)](
                                     td::Result<tl_object_ptr<tos_api::storage_daemon_provider_params>> R) {
      if (R.is_error()) {
        return;
      }
      if (json) {
  ...
  td::Status execute_set_provider_params(OptionalProviderParams new_params) {
    auto query_get = create_tl_object<tos_api::storage_daemon_getProviderParams>();
    send_query(std::move(query_get), [SelfId = actor_id(this), new_params = std::move(new_params)](
                                         td::Result<tl_object_ptr<tos_api::storage_daemon_provider_params>> R) mutable {
      if (R.is_error()) {
        return;
      }
  ...
  void execute_set_provider_params_cont(tl_object_ptr<tos_api::storage_daemon_provider_params> params,
                                        OptionalProviderParams new_params) {
    ...
    auto query_set = create_tl_object<tos_api::storage_daemon_setProviderParams>(std::move(params));
    send_query(std::move(query_set),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) mutable {
                 if (R.is_error()) {
                   return;
                 }
  ...
  td::Status execute_get_provider_info(bool with_balances, bool with_contracts, bool json) {
    auto query = create_tl_object<tos_api::storage_daemon_getProviderInfo>(with_balances, with_contracts);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_providerInfo>> R) {
                 if (R.is_error()) {
                   return;
                 }
                 if (json) {
  ...
  td::Status execute_set_provider_config(OptionalProviderConfig new_config) {
    auto query_get = create_tl_object<tos_api::storage_daemon_getProviderInfo>(false, false);
    send_query(std::move(query_get), [SelfId = actor_id(this), new_config = std::move(new_config)](
                                         td::Result<tl_object_ptr<tos_api::storage_daemon_providerInfo>> R) mutable {
      if (R.is_error()) {
        return;
      }
      auto info = R.move_as_ok();
  ...
  void execute_set_provider_config_cont(tl_object_ptr<tos_api::storage_daemon_providerConfig> config,
                                        OptionalProviderConfig new_config) {
    ...
    auto query_set = create_tl_object<tos_api::storage_daemon_setProviderConfig>(std::move(config));
    send_query(std::move(query_set),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) mutable {
                 if (R.is_error()) {
                   return;
  ...
  td::Status execute_withdraw(std::string address) {
    auto query = create_tl_object<tos_api::storage_daemon_withdraw>(std::move(address));
  ...
  td::Status execute_withdraw_all() {
    auto query = create_tl_object<tos_api::storage_daemon_getProviderInfo>(true, true);
    send_query(std::move(query),
               [=, SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_providerInfo>> R) {
                 if (R.is_error()) {
                   return;
  ...
  void execute_withdraw_all_cont(std::vector<std::string> addresses) {
    ...
    for (auto& address : addresses) {
      auto query = create_tl_object<tos_api::storage_daemon_withdraw>(std::move(address));
      send_query(std::move(query),
                 ig.get_promise().wrap([](tl_object_ptr<tos_api::storage_daemon_success>) { return td::Unit(); }));
    }
  }

  td::Status execute_send_coins(std::string address, std::string amount, std::string message) {
    auto query =
        create_tl_object<tos_api::storage_daemon_sendCoins>(std::move(address), std::move(amount), std::move(message));
  ...
  td::Status execute_close_contract(std::string address) {
    auto query = create_tl_object<tos_api::storage_daemon_closeStorageContract>(std::move(address));
    send_query(std::move(query),
               [SelfId = actor_id(this)](td::Result<tl_object_ptr<tos_api::storage_daemon_success>> R) {
                 if (R.is_error()) {
                   return;
    ...
    td::actor::send_closure(
        ...
        [SelfId = actor_id(this), promise = std::move(promise), process_error](td::Result<td::BufferSlice> R) mutable {
          ...
          if (R.is_error()) {
            ...
            if (result.is_error()) {
              auto R3 = fetch_tl_object<tos_api::storage_daemon_queryError>(data, true);
              if (R3.is_ok()) {
 ...
 private:
  ...
  void print_torrent_full(tl_object_ptr<tos_api::storage_daemon_torrentFull> ptr) {
    auto& obj = *ptr;
  ...
  void print_torrent_list(tl_object_ptr<tos_api::storage_daemon_torrentList> ptr, bool with_hashes) {
    auto& obj = *ptr;
    ...
    std::sort(obj.torrents_.begin(), obj.torrents_.end(),
              [&](const tl_object_ptr<tos_api::storage_daemon_torrent>& a,
                  const tl_object_ptr<tos_api::storage_daemon_torrent>& b) {
...
int main(int argc, char* argv[]) {
  ...
  tos::PublicKey server_public_key;
  std::vector<std::string> commands;
  td::OptionParser p;
  ...
  p.add_checked_option('k', "key", "private key", [&](td::Slice arg) {
    ...
    TRY_RESULT_ASSIGN(client_private_key, tos::PrivateKey::import(data));
    return td::Status::OK();
  });
  p.add_checked_option('p', "pub", "server public key", [&](td::Slice arg) {
    TRY_RESULT_PREFIX(data, td::read_file(arg.str()), "failed to read: ");
    TRY_RESULT_ASSIGN(server_public_key, tos::PublicKey::import(data));
    return td::Status::OK();
  });
  ...
  scheduler.run_in_context([&] {
    td::actor::create_actor<tos::StorageDaemonCli>("console", ip_addr, client_private_key, server_public_key,
                                                   std::move(commands))
        .release();
  });
  scheduler.run();
