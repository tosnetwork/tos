...
class StorageManager : public td::actor::Actor {
 public:
  ...
  StorageManager(adnl::AdnlNodeIdShort local_id, std::string db_root, td::unique_ptr<Callback> callback,
                 bool client_mode, td::actor::ActorId<adnl::Adnl> adnl, td::actor::ActorId<tos_rldp::Rldp> rldp,
  ...
  void get_peers_info(td::Bits256 hash, td::Promise<tl_object_ptr<tos_api::storage_daemon_peerList>> promise);
 ...
 private:
  ...
  void loaded_config_from_db(tl_object_ptr<tos_api::storage_db_config> config);
