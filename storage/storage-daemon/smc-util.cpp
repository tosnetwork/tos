...
static void smc_forget(td::actor::ActorId<toslib::ToslibClientWrapper> client, td::int64 id) {
  auto query = create_tl_object<toslib_api::smc_forget>(id);
  td::actor::send_closure(client, &toslib::ToslibClientWrapper::send_request<toslib_api::smc_forget>, std::move(query),
                          [](td::Result<toslib_api::object_ptr<toslib_api::ok>> R) mutable {
                            if (R.is_error()) {
...
void run_get_method(ContractAddress address, td::actor::ActorId<toslib::ToslibClientWrapper> client, std::string method,
                    std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>> args,
                    td::Promise<std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>>> promise) {
  LOG(DEBUG) << "Running get method " << method << " on " << address.to_string();
  auto query =
      create_tl_object<toslib_api::smc_load>(create_tl_object<toslib_api::accountAddress>(address.to_string()));
  td::actor::send_closure(
      client, &toslib::ToslibClientWrapper::send_request<toslib_api::smc_load>, std::move(query),
      [client, method = std::move(method), args = std::move(args),
       promise = std::move(promise)](td::Result<toslib_api::object_ptr<toslib_api::smc_info>> R) mutable {
        TRY_RESULT_PROMISE(promise, obj, std::move(R));
        auto query = create_tl_object<toslib_api::smc_runGetMethod>(
            obj->id_, create_tl_object<toslib_api::smc_methodIdName>(std::move(method)), std::move(args));
        td::actor::send_closure(
            client, &toslib::ToslibClientWrapper::send_request<toslib_api::smc_runGetMethod>, std::move(query),
            [client, id = obj->id_,
             promise = std::move(promise)](td::Result<toslib_api::object_ptr<toslib_api::smc_runResult>> R) mutable {
...
void check_contract_exists(ContractAddress address, td::actor::ActorId<toslib::ToslibClientWrapper> client,
                           td::Promise<bool> promise) {
  auto query =
      create_tl_object<toslib_api::smc_load>(create_tl_object<toslib_api::accountAddress>(address.to_string()));
  td::actor::send_closure(
      client, &toslib::ToslibClientWrapper::send_request<toslib_api::smc_load>, std::move(query),
      [client, promise = std::move(promise)](td::Result<toslib_api::object_ptr<toslib_api::smc_info>> R) mutable {
        TRY_RESULT_PROMISE(promise, obj, std::move(R));
        auto query = create_tl_object<toslib_api::smc_getState>(obj->id_);
        td::actor::send_closure(
            client, &toslib::ToslibClientWrapper::send_request<toslib_api::smc_getState>, std::move(query),
            [client, id = obj->id_,
             promise = std::move(promise)](td::Result<toslib_api::object_ptr<toslib_api::tvm_cell>> R) mutable {
              smc_forget(client, id);
...
void get_contract_balance(ContractAddress address, td::actor::ActorId<toslib::ToslibClientWrapper> client,
                          td::Promise<td::RefInt256> promise) {
  auto query =
      create_tl_object<toslib_api::getAccountState>(create_tl_object<toslib_api::accountAddress>(address.to_string()));
  td::actor::send_closure(
      client, &toslib::ToslibClientWrapper::send_request<toslib_api::getAccountState>, std::move(query),
      promise.wrap([](toslib_api::object_ptr<toslib_api::fullAccountState> r) -> td::Result<td::RefInt256> {
        return td::make_refint(r->balance_);
      }));
}

FabricContractWrapper::FabricContractWrapper(ContractAddress address,
                                             td::actor::ActorId<toslib::ToslibClientWrapper> client,
...
void FabricContractWrapper::load_transactions() {
  ...
  auto query =
      create_tl_object<toslib_api::getAccountState>(create_tl_object<toslib_api::accountAddress>(address_.to_string()));
  td::actor::send_closure(
      client_, &toslib::ToslibClientWrapper::send_request<toslib_api::getAccountState>, std::move(query),
      [SelfId = actor_id(this)](td::Result<toslib_api::object_ptr<toslib_api::fullAccountState>> R) mutable {
        if (R.is_error()) {
        ...
        td::actor::send_closure(SelfId, &FabricContractWrapper::load_last_transactions,
                                std::vector<tl_object_ptr<toslib_api::raw_transaction>>(),
                                std::move(obj->last_transaction_id_), (td::uint32)obj->sync_utime_);
      });
}

void FabricContractWrapper::load_last_transactions(std::vector<tl_object_ptr<toslib_api::raw_transaction>> transactions,
                                                   tl_object_ptr<toslib_api::internal_transactionId> next_id,
                                                   td::uint32 utime) {
  if ((td::uint64)next_id->lt_ <= last_processed_lt_) {
    loaded_last_transactions(std::make_pair(std::move(transactions), utime));
    return;
  }
  auto query = create_tl_object<toslib_api::raw_getTransactionsV2>(
      nullptr, create_tl_object<toslib_api::accountAddress>(address_.to_string()), std::move(next_id), 10, false);
  td::actor::send_closure(
      client_, &toslib::ToslibClientWrapper::send_request<toslib_api::raw_getTransactionsV2>, std::move(query),
      [transactions = std::move(transactions), last_processed_lt = last_processed_lt_, SelfId = actor_id(this),
       utime](td::Result<toslib_api::object_ptr<toslib_api::raw_transactions>> R) mutable {
        if (R.is_error()) {
          td::actor::send_closure(SelfId, &FabricContractWrapper::loaded_last_transactions, R.move_as_error());
          return;
        }
...
void FabricContractWrapper::loaded_last_transactions(
    td::Result<std::pair<std::vector<tl_object_ptr<toslib_api::raw_transaction>>, td::uint32>> R) {
  if (R.is_error()) {
  ...
  for (tl_object_ptr<toslib_api::raw_transaction>& transaction : transactions) {
    ...
    if (current_ext_message_ && current_ext_message_.value().sent &&
      ...
      auto msg_data = dynamic_cast<toslib_api::msg_dataRaw*>(transaction->in_msg_->msg_data_.get());
      if (msg_data == nullptr) {
        continue;
      }
      auto r_body = vm::std_boc_deserialize(msg_data->body_);
      if (r_body.is_error()) {
        LOG(WARNING) << "Invalid response from toslib: " << r_body.move_as_error();
        continue;
      }
...
void FabricContractWrapper::run_get_method(
    std::string method, std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>> args,
    td::Promise<std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>>> promise) {
  tos::run_get_method(address_, client_, std::move(method), std::move(args), std::move(promise));
}
...
void FabricContractWrapper::do_send_external_message() {
  ...
  run_get_method(
      "get_wallet_params", {},
      [SelfId = actor_id(this)](td::Result<std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>>> R) {
        td::uint32 seqno = 0;
...
void FabricContractWrapper::do_send_external_message_cont2(td::Ref<vm::Cell> ext_msg_body) {
  ...
  auto query = create_tl_object<toslib_api::raw_createAndSendMessage>(
      create_tl_object<toslib_api::accountAddress>(address_.to_string()), "", std::move(body));
  td::actor::send_closure(client_, &toslib::ToslibClientWrapper::send_request<toslib_api::raw_createAndSendMessage>,
                          std::move(query), [SelfId = actor_id(this)](td::Result<tl_object_ptr<toslib_api::ok>> R) {
                            if (R.is_error()) {
                              td::actor::send_closure(SelfId, &FabricContractWrapper::do_send_external_message_finish,
...
void FabricContractWrapper::do_send_external_message_finish(
    td::Result<const std::vector<tl_object_ptr<toslib_api::raw_message>>*> R) {
  CHECK(current_ext_message_);
  if (R.is_error()) {
...
void get_storage_contract_data(ContractAddress address, td::actor::ActorId<toslib::ToslibClientWrapper> client,
                               td::Promise<StorageContractData> promise) {
  run_get_method(
      address, client, "get_storage_contract_data", {},
      promise.wrap([](std::vector<tl_object_ptr<toslib_api::tvm_StackEntry>> stack) -> td::Result<StorageContractData> {
        if (stack.size() < 11) {
