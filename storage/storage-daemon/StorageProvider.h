...
struct ProviderParams {
  ...
  static td::Result<ProviderParams> create(const tl_object_ptr<tos_api::storage_daemon_provider_params>& obj);
  tl_object_ptr<tos_api::storage_daemon_provider_params> tl() const;
...
class StorageProvider : public td::actor::Actor {
 public:
  struct Config {
    ...
    Config() = default;
    explicit Config(const tl_object_ptr<tos_api::storage_daemon_providerConfig>& obj);
    tl_object_ptr<tos_api::storage_daemon_providerConfig> tl() const;
  };
  ...
  static void get_provider_params(td::actor::ActorId<toslib::ToslibClientWrapper>, ContractAddress address,
 ...
 private:
  ...
  void process_transaction(tl_object_ptr<toslib_api::raw_transaction> transaction);
