...
-keep class avata.Classes {
   java.lang.Class forName(java.lang.String, boolean, java.lang.ClassLoader);
   int findField(avata.VMClass, java.lang.String);
   int findMethod(avata.VMClass, java.lang.String, java.lang.Class[]);
...
-keep class avata.avatavmresource.Handler
