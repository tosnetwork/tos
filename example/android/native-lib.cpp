...
extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_toslib_MainActivity_stringFromJNI(JNIEnv *env,
                                                                                          jobject /* this */,
                                                                                          jstring dir) {
  ...
  query += "\"}";
  return env->NewStringUTF(toslib_client_json_execute(nullptr, query.c_str()));

  //return env->NewStringUTF(hello.c_str());
}

extern "C" JNIEXPORT jlong JNICALL Java_drinkless_org_toslib_ClientJsonNative_create(JNIEnv *env, jobject /* this */) {
  return reinterpret_cast<jlong>(toslib_client_json_create());
}
extern "C" JNIEXPORT void JNICALL Java_drinkless_org_toslib_ClientJsonNative_send(JNIEnv *env, jobject /* this */,
                                                                                  jlong client, jstring j_query) {
  auto query = td::jni::from_jstring(env, j_query);
  return toslib_client_json_send(reinterpret_cast<void *>(client), query.c_str());
}
extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_toslib_ClientJsonNative_execute(JNIEnv *env, jobject /* this */,
                                                                                        jstring j_query) {
  auto query = td::jni::from_jstring(env, j_query);
  return td::jni::to_jstring(env, toslib_client_json_execute(nullptr, query.c_str()));
}
extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_toslib_ClientJsonNative_receive(JNIEnv *env, jobject /* this */,
                                                                                        jlong client, jdouble timeout) {
  return td::jni::to_jstring(env, toslib_client_json_receive(reinterpret_cast<void *>(client), timeout));
}
extern "C" JNIEXPORT void JNICALL Java_drinkless_org_toslib_ClientJsonNative_destroy(JNIEnv *env, jobject /* this */,
                                                                                     jlong client) {
  return toslib_client_json_destroy(reinterpret_cast<void *>(client));
}
...
static toslib_api::object_ptr<toslib_api::Function> fetch_function(JNIEnv *env, jobject function) {
  td::jni::reset_parse_error();
  auto result = toslib_api::Function::fetch(env, function);
...
static toslib::Client *get_client(jlong client_id) {
  return reinterpret_cast<toslib::Client *>(static_cast<std::uintptr_t>(client_id));
}

static jlong Client_createNativeClient(JNIEnv *env, jclass clazz) {
  return static_cast<jlong>(reinterpret_cast<std::uintptr_t>(new toslib::Client()));
}
...
static jobject Client_nativeClientExecute(JNIEnv *env, jclass clazz, jobject function) {
  jobject result;
  toslib::Client::execute({0, fetch_function(env, function)}).object->store(env, result);
  return result;
}
...
static jstring Object_toString(JNIEnv *env, jobject object) {
  return td::jni::to_jstring(env, to_string(toslib_api::Object::fetch(env, object)));
}

static jstring Function_toString(JNIEnv *env, jobject object) {
  return td::jni::to_jstring(env, to_string(toslib_api::Function::fetch(env, object)));
}
...
static jint register_native(JavaVM *vm) {
  ...
  auto object_class = td::jni::get_jclass(env, PACKAGE_NAME "/TosApi$Object");
  auto function_class = td::jni::get_jclass(env, PACKAGE_NAME "/TosApi$Function");

#define TD_OBJECT "L" PACKAGE_NAME "/TosApi$Object;"
#define TD_FUNCTION "L" PACKAGE_NAME "/TosApi$Function;"
...
#undef TD_OBJECT
  ...
  toslib_api::Object::init_jni_vars(env, PACKAGE_NAME);
  toslib_api::Function::init_jni_vars(env, PACKAGE_NAME);
  // FIXME
