...
echo "[build-all.sh] Building toslib for x86..."
echo
ARCH="x86" ./build.sh || exit 1

echo "[build-all.sh] Building toslib for x86_64..."
echo
ARCH="x86_64" ./build.sh || exit 1

echo "[build-all.sh] Building toslib for arm..."
echo
ARCH="arm" ./build.sh || exit 1

echo "[build-all.sh] Building toslib for arm64..."
echo
