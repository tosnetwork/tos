...
/**
 * Main class for interaction with the toslib.
 */
public final class Client implements Runnable {
    ...
    /**
     * Interface for handler for results of queries to toslib and incoming updates from toslib.
     */
    ...
    /**
     * Sends a request to the toslib with an empty ExceptionHandler.
     *
     * @param query         Object representing a query to the toslib.
     * @param resultHandler Result handler with onResult method which will be called with result
    ...
    /**
     * Synchronously executes a toslib request. Only a few marked accordingly requests can be executed synchronously.
     *
     * @param query Object representing a query to the toslib.
    ...
    /**
     * Replaces handler for incoming updates from the toslib. Sets empty ExceptionHandler.
     *
     * @param updatesHandler Handler with onResult method which will be called for every incoming
     *                       update from the toslib.
     */
    ...
    public static Client create(ResultHandler updatesHandler, ExceptionHandler updatesExceptionHandler, ExceptionHandler defaultExceptionHandler) {
        ...
        new Thread(client, "toslib thread").start();
        return client;
    }
