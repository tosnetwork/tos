...
struct ValidatorSessionStats {
  ...
  struct Producer {
    ...
    tl_object_ptr<tos_api::validatorStats_stats_producer> tl() const {
      ...
      int flags =
          (block_status != status_none || !candidate_id.is_zero()
               ? tos_api::validatorStats_stats_producer::Flags::BLOCK_ID_MASK
               : 0) |
          (collated_at >= 0.0 ? tos_api::validatorStats_stats_producer::Flags::COLLATED_AT_MASK : 0) |
          (!collator_node_id.is_zero() ? tos_api::validatorStats_stats_producer::Flags::COLLATOR_NODE_ID_MASK : 0) |
          (validated_at >= 0.0 ? tos_api::validatorStats_stats_producer::Flags::VALIDATED_AT_MASK : 0) |
          (serialize_time >= 0.0 || deserialize_time >= 0.0 || serialized_size >= 0
               ? tos_api::validatorStats_stats_producer::Flags::SERIALIZE_TIME_MASK
               : 0);
      return create_tl_object<tos_api::validatorStats_stats_producer>(
  ...
  struct Round {
    ...
    tl_object_ptr<tos_api::validatorStats_stats_round> tl() const {
      std::vector<tl_object_ptr<tos_api::validatorStats_stats_producer>> producers_tl;
      for (const auto &producer : producers) {
        producers_tl.push_back(producer.tl());
      }
      return create_tl_object<tos_api::validatorStats_stats_round>(started_at, std::move(producers_tl));
    }
  };
  ...
  tl_object_ptr<tos_api::validatorStats_stats> tl() const {
    std::vector<tl_object_ptr<tos_api::validatorStats_stats_round>> rounds_tl;
    for (const auto &round : rounds) {
      rounds_tl.push_back(round.tl());
    }
    int flags = success ? tos_api::validatorStats_stats::Flags::CREATOR_MASK : 0;
    return create_tl_object<tos_api::validatorStats_stats>(
