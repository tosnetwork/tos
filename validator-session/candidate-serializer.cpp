...
td::Result<tl_object_ptr<tos_api::validatorSession_candidate>> deserialize_candidate(td::Slice data,
  ...
  TRY_RESULT(f, fetch_tl_object<tos_api::validatorSession_Candidate>(data, true));
  td::Result<tl_object_ptr<tos_api::validatorSession_candidate>> res;
  tos_api::downcast_call(
      *f, td::overloaded(
              [&](tos_api::validatorSession_candidate& c) {
