...
td::StringBuilder& operator<<(td::StringBuilder& sb, const tos::tos_api::validatorSession_round_Message& message) {
  tos::tos_api::downcast_call(
      const_cast<tos::tos_api::validatorSession_round_Message&>(message),
      td::overloaded(
          [&](const tos::tos_api::validatorSession_message_submittedBlock& obj) {
            sb << "SUBMIT(" << obj.round_ << "," << obj.root_hash_ << "," << obj.file_hash_
               << obj.collated_data_file_hash_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_approvedBlock& obj) {
            sb << "APPROVE(" << obj.round_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_rejectedBlock& obj) {
            sb << "REJECT(" << obj.round_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_commit& obj) {
            sb << "COMMIT(" << obj.round_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_vote& obj) {
            sb << "VOTE(" << obj.round_ << "," << obj.attempt_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_voteFor& obj) {
            sb << "VOTEFOR(" << obj.round_ << "," << obj.attempt_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_precommit& obj) {
            sb << "PRECOMMIT(" << obj.round_ << "," << obj.attempt_ << "," << obj.candidate_ << ")";
          },
          [&](const tos::tos_api::validatorSession_message_empty& obj) {
...
static td::uint32 get_round_id(const tos_api::validatorSession_round_Message* message) {
  td::uint32 round = 0;
  bool is_called = tos_api::downcast_call(*const_cast<tos_api::validatorSession_round_Message*>(message),
...
const ValidatorSessionOldRoundState* ValidatorSessionOldRoundState::action(
    ...
    const tos_api::validatorSession_message_approvedBlock& act) {
...
const ValidatorSessionOldRoundState* ValidatorSessionOldRoundState::action(
    ValidatorSessionDescription& desc, const ValidatorSessionOldRoundState* state, td::uint32 src_idx, td::uint32 att,
    const tos_api::validatorSession_message_commit& act) {
...
const ValidatorSessionOldRoundState* ValidatorSessionOldRoundState::action(
    ValidatorSessionDescription& desc, const ValidatorSessionOldRoundState* state, td::uint32 src_idx, td::uint32 att,
    const tos_api::validatorSession_round_Message* act) {
  tos_api::downcast_call(*const_cast<tos_api::validatorSession_round_Message*>(act),
...
const ValidatorSessionRoundState* ValidatorSessionRoundState::action(
    ...
    const tos_api::validatorSession_message_submittedBlock& act) {
...
const ValidatorSessionRoundState* ValidatorSessionRoundState::action(
    ValidatorSessionDescription& desc, const ValidatorSessionRoundState* state, td::uint32 src_idx, td::uint32 att,
    const tos_api::validatorSession_message_rejectedBlock& act) {
...
const ValidatorSessionRoundState* ValidatorSessionRoundState::forward_action_to_attempt(
    ...
    const tos_api::validatorSession_round_Message* act) {
  if (state->precommitted_) {
    if (act->get_id() != tos_api::validatorSession_message_empty::ID) {
      VLOG(VALIDATOR_SESSION_WARNING) << "[validator session][node " << desc.get_source_id(src_idx) << "][" << *act
  ...
  tos_api::downcast_call(*const_cast<tos_api::validatorSession_round_Message*>(act), [&](auto& obj) {
...
tl_object_ptr<tos_api::validatorSession_message_voteFor> ValidatorSessionRoundState::generate_vote_for(
  ...
  return create_tl_object<tos_api::validatorSession_message_voteFor>(get_seqno(), static_cast<td::int32>(att),
                                                                     v[x % v.size()]);
}
...
tl_object_ptr<tos_api::validatorSession_round_Message> ValidatorSessionRoundState::create_action(
    ValidatorSessionDescription& desc, td::uint32 src_idx, td::uint32 att) const {
  if (precommitted_) {
    return create_tl_object<tos_api::validatorSession_message_empty>(seqno_, att);
  }
  ...
  return create_tl_object<tos_api::validatorSession_message_vote>(seqno_, att, block_id);
}
...
const ValidatorSessionState* ValidatorSessionState::action(ValidatorSessionDescription& desc,
                                                           ...
                                                           td::uint32 att,
                                                           const tos_api::validatorSession_round_Message* action) {
  if (action) {
...
tl_object_ptr<tos_api::validatorSession_round_Message> ValidatorSessionState::create_action(
    ValidatorSessionDescription& desc, td::uint32 src_idx, td::uint32 att) const {
