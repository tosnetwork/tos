...
set(MHD_SOURCE_DIR ${TOS_THIRD_PARTY_SOURCE_DIR}/libmicrohttpd)
set(MHD_BINARY_DIR ${TOS_THIRD_PARTY_BINARY_DIR}/libmicrohttpd)
...
elseif (MSVC)
  ...
  if (ANDROID)
    set(MHD_BINARY_DIR ${TOS_ANDROID_THIRD_PARTY_DIR}/libmicrohttpd/${TOS_ANDROID_ARCH_DIR})
    set(MHD_BUILD_DIR ${MHD_BINARY_DIR}/src)
  endif()
  ...
  if (ANDROID)
    list(APPEND MHD_CONFIGURE_ARGS --host=${TOS_ANDROID_HOST})
  endif()
  ...
  if (MINGW)
    ...
    if (ANDROID)
      set(MHD_CC ${TOS_ANDROID_CC})
      set(MHD_CXX ${TOS_ANDROID_CXX})
      set(MHD_AR ${TOS_ANDROID_AR})
      set(MHD_RANLIB ${TOS_ANDROID_RANLIB})
    else()
