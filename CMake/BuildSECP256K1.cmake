...
if (NOT SECP256K1_LIBRARY)
  ...
  elseif (ANDROID OR NOT NIX)
    if (ANDROID)
      set(SECP256K1_BINARY_DIR ${TOS_ANDROID_THIRD_PARTY_DIR}/secp256k1/${TOS_ANDROID_ARCH_DIR})
      set(SECP256K1_BUILD_DIR ${SECP256K1_BINARY_DIR}/src)
      set(SECP256K1_CC ${TOS_ANDROID_CC})
      set(SECP256K1_CXX ${TOS_ANDROID_CXX})
      set(SECP256K1_AR ${TOS_ANDROID_AR})
      set(SECP256K1_RANLIB ${TOS_ANDROID_RANLIB})
    elseif (MINGW)
