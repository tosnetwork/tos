...
set(SODIUM_SOURCE_DIR ${TOS_THIRD_PARTY_SOURCE_DIR}/sodium)
set(SODIUM_BINARY_DIR ${TOS_THIRD_PARTY_BINARY_DIR}/sodium)
...
elseif (ANDROID OR NOT NIX)
  if (ANDROID)
    set(SODIUM_BINARY_DIR ${TOS_ANDROID_THIRD_PARTY_DIR}/libsodium/${TOS_ANDROID_SODIUM_DIR})
    set(SODIUM_BUILD_DIR ${SODIUM_BINARY_DIR}/src)
    set(SODIUM_CC ${TOS_ANDROID_CC})
    set(SODIUM_CXX ${TOS_ANDROID_CXX})
    set(SODIUM_AR ${TOS_ANDROID_AR})
    set(SODIUM_RANLIB ${TOS_ANDROID_RANLIB})
  elseif (MINGW)
  ...
  if (ANDROID)
    list(APPEND SODIUM_CONFIGURE_ARGS --host=${TOS_ANDROID_HOST})
  endif()
