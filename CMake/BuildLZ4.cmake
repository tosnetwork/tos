...
set(LZ4_SOURCE_DIR ${TOS_THIRD_PARTY_SOURCE_DIR}/lz4)
set(LZ4_BINARY_DIR ${TOS_THIRD_PARTY_BINARY_DIR}/lz4)

if (USE_EMSCRIPTEN OR EMSCRIPTEN)
  set(LZ4_BINARY_DIR ${TOS_THIRD_PARTY_BINARY_DIR}/lz4-emscripten)
...
elseif (ANDROID)
  set(LZ4_BINARY_DIR ${TOS_ANDROID_THIRD_PARTY_DIR}/lz4/${TOS_ANDROID_ARCH_DIR})
  set(LZ4_BUILD_DIR ${LZ4_BINARY_DIR}/cmake)
  set(LZ4_CMAKE_SOURCE_DIR ${LZ4_BINARY_DIR}/src)
  set(LZ4_INCLUDE_DIRS ${TOS_ANDROID_THIRD_PARTY_DIR}/lz4/include)
  set(LZ4_LIBRARY ${LZ4_BINARY_DIR}/lib/liblz4.a)
  set(LZ4_ARCH_STAMP ${LZ4_BINARY_DIR}/.android_arch)
  set(LZ4_ARCH_EXPECTED "${TOS_ANDROID_ABI};${TOS_ANDROID_API};${TOS_ANDROID_CC}")
  ...
  if (TOS_ANDROID_ABI)
    list(APPEND LZ4_ANDROID_CMAKE_ARGS -DANDROID_ABI=${TOS_ANDROID_ABI})
  endif()
  if (ANDROID_PLATFORM)
