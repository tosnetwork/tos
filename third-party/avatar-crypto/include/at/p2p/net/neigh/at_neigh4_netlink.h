#ifndef HEADER_at_src_waltz_neigh_at_neigh4_netlink_h
#define HEADER_at_src_waltz_neigh_at_neigh4_netlink_h

/* at_neigh4_netlink.h provides APIs for importing IPv4 neighbors from
...
/* AT_NEIGH_NETLINK_* gives error codes for netlink import operations. */

AT_PROTOTYPES_BEGIN

/* at_neigh4_netlink_request_dump requests a dump of the IPv4 neighbor
...
int
at_neigh4_netlink_request_dump( at_netlink_t * netlink,
                                uint           if_idx );

/* at_neigh4_netlink_ingest_message imports an RTM_NEWNEIGH or RTM_DELNEIGH
...
void
at_neigh4_netlink_ingest_message( at_neigh4_hmap_t *      map,
...
#endif /* HEADER_at_src_waltz_neigh_at_neigh4_netlink_h */
