#ifndef HEADER_at_src_util_simd_test_avx512_h
#define HEADER_at_src_util_simd_test_avx512_h
...
AT_STATIC_ASSERT( WW_WIDTH       ==16, unit_test );
AT_STATIC_ASSERT( WW_FOOTPRINT   ==64, unit_test );
AT_STATIC_ASSERT( WW_ALIGN       ==64, unit_test );
AT_STATIC_ASSERT( WW_LG_WIDTH    == 4, unit_test );
AT_STATIC_ASSERT( WW_LG_FOOTPRINT== 6, unit_test );
AT_STATIC_ASSERT( WW_LG_ALIGN    == 6, unit_test );
...
#define WWI_TEST( x, x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,xa,xb,xc,xd,xe,xf ) do {                                                             \
    ...
    for( int _lane=0; _lane<16; _lane++ )                                                                                               \
      if( AT_UNLIKELY( _t[_lane]!=_u[_lane] ) )                                                                                         \
        AT_LOG_ERR(( "FAIL: %s @ lane %i\n\t"                                                                                           \
...
#endif /* HEADER_at_src_util_simd_test_avx512_h */