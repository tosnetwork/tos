...
#error "Do not include this directly; use at_avx.h"
#endif
...
#if AT_USING_CLANG /* Sigh ... clang is sad and can't handle passing compile time const expressions through a static inline */
