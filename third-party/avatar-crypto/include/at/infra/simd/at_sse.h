#ifndef HEADER_at_src_util_simd_at_sse_h
#define HEADER_at_src_util_simd_at_sse_h
...
#include "at_sse_vc.h" /* Vector conditional support */
#include "at_sse_vf.h" /* Vector float support */
#include "at_sse_vi.h" /* Vector int support */
#include "at_sse_vu.h" /* Vector uint support */
#include "at_sse_vd.h" /* Vector double support */
#include "at_sse_vl.h" /* Vector long support */
#include "at_sse_vv.h" /* Vector ulong support */
#include "at_sse_vb.h" /* Vector uchar (byte) support */

#else
#error "Build target does not support SSE wrappers"
#endif

#endif /* HEADER_at_src_util_simd_at_sse_h */
