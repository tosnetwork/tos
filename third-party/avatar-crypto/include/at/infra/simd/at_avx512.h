#ifndef HEADER_at_src_util_simd_at_avx512_h
#define HEADER_at_src_util_simd_at_avx512_h
...
//#include "at_avx512_wwf.h" /* Vector float support */
#include "at_avx512_wwi.h" /* Vector int support */
#include "at_avx512_wwu.h" /* Vector uint support */
//#include "at_avx512_wwd.h" /* Vector double support */
#include "at_avx512_wwl.h" /* Vector long support */
#include "at_avx512_wwv.h" /* Vector ulong support */
#include "at_avx512_wwb.h" /* Vector uchar (byte) support */
#include "at_avx512_wwh.h" /* Vector ushort support */

#else
#error "Build target does not support AVX512 wrappers"
#endif

#endif /* HEADER_at_src_util_simd_at_avx512_h */