#ifndef HEADER_at_src_ballet_secp256r1_at_secp256r1_private_h
#define HEADER_at_src_ballet_secp256r1_at_secp256r1_private_h

/* at_secp256r1 provides APIs for secp256r1 signature verification. */

#include "at_secp256r1.h"
#include "at/infra/uint256/at_uint256.h"

AT_PROTOTYPES_BEGIN

/* Field element: uint256 */
typedef at_uint256_t at_secp256r1_fp_t;

/* Scalar field element: uint256 */
typedef at_uint256_t at_secp256r1_scalar_t;

/* Point, in Jacobian coordinates (X : Y : Z).
   These correspond to affine x=X/Z^2, y=Y/Z^3.
   Field elements are in Montgomery form. */
struct at_secp256r1_point {
  at_secp256r1_fp_t x[1];
  at_secp256r1_fp_t y[1];
  at_secp256r1_fp_t z[1];
};
typedef struct at_secp256r1_point at_secp256r1_point_t;

/* const 0. */
static const at_uint256_t at_secp256r1_const_zero[1] = {{{
...
static const at_secp256r1_fp_t at_secp256r1_const_p[1] = {{{
...
static const at_secp256r1_fp_t at_secp256r1_const_one_mont[1] = {{{
...
static const at_secp256r1_fp_t at_secp256r1_const_a_mont[1] = {{{
...
static const at_secp256r1_fp_t at_secp256r1_const_b_mont[1] = {{{
...
static const at_secp256r1_scalar_t at_secp256r1_const_n[1] = {{{
...
static const at_secp256r1_scalar_t at_secp256r1_const_n_m1_half[1] = {{{
  0x79dce5617e3192a8, 0xde737d56d38bcf42, 0x7fffffffffffffff, 0x7fffffff80000000,
}}};

AT_PROTOTYPES_END

#include "at_secp256r1_s2n.c"

#endif /* HEADER_at_src_ballet_secp256r1_at_secp256r1_private_h */