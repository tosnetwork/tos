#ifndef HEADER_at_src_ballet_blake3_at_blake3_private_h
#define HEADER_at_src_ballet_blake3_at_blake3_private_h

#include "at_blake3.h"

/* Set AT_BLAKE3_TRACING to 1 to dump out a high-level trace of BLAKE3
   operations to the debug log.  This is useful during debugging or
   development. */
#define AT_BLAKE3_TRACING 0

#if AT_BLAKE3_TRACING
#define AT_BLAKE3_TRACE( ... ) AT_LOG_DEBUG( __VA_ARGS__ )
#else
#define AT_BLAKE3_TRACE( ... ) (void)0
#endif

/* Protocol constants *************************************************/

static const uchar AT_BLAKE3_MSG_SCHEDULE[7][16] = {
...
static const uint AT_BLAKE3_IV[8] = {
  0x6A09E667UL, 0xBB67AE85UL, 0x3C6EF372UL, 0xA54FF53AUL,
  0x510E527FUL, 0x9B05688CUL, 0x1F83D9ABUL, 0x5BE0CD19UL
};

#define AT_BLAKE3_FLAG_CHUNK_START (1u<<0) /* 1 */
#define AT_BLAKE3_FLAG_CHUNK_END   (1u<<1) /* 2 */
#define AT_BLAKE3_FLAG_PARENT      (1u<<2) /* 4 */
#define AT_BLAKE3_FLAG_ROOT        (1u<<3) /* 8 */
...
union __attribute__((aligned(32))) at_blake3_op {
...
typedef union at_blake3_op at_blake3_op_t;
...
void
at_blake3_ref_compress1( uchar * restrict       out, /* align==1 len==32 */
...
void
at_blake3_sse_compress1( uchar * restrict       out, /* align==1 len==32 */
                         uchar const * restrict msg, /* align==1 len==64 */
                         uint                   msg_sz,
                         ulong                  counter,
                         uint                   flags,
...
void
at_blake3_avx_compress8_fast( uchar const * restrict batch_data,  /* align==32 len==8*64 */
...
/* at_blake3_avx512_compress16{,fast} are analogous to the avx APIs
...
void
at_blake3_avx512_compress16_fast( uchar const * restrict batch_data,  /* align==32 len==16*64 */
...
#endif /* HEADER_at_src_ballet_blake3_at_blake3_private_h */