#ifndef HEADER_at_src_ballet_ed25519_at_x25519_h
#define HEADER_at_src_ballet_ed25519_at_x25519_h

/* at_x25519 provides an API for the X25519 ECDH key exchange.
   ...
   about the original secret.  (provided by at_x25519_public).
   ...
   Using at_x25519_exchange, both parties then derive the same shared
   secret using inputs (a, Gb) and (b, Ga). */

#include "at_crypto_base.h"

#define AT_X25519_SECRET_SZ (32UL)

AT_PROTOTYPES_BEGIN

/* at_x25519_public generates an X25519 public key (curve point) given
   ...
   peer_public_key input to at_x25519_exchange. */

uchar * AT_FN_SENSITIVE
at_x25519_public( uchar       self_public_key [ 32 ],
                  uchar const self_private_key[ 32 ] );

/* at_x25519_exchange computes a shared secret given an arbitrary 32
   ...
   (This is never the case when using at_x25519_public. However, peer_public_key
...
#endif /* HEADER_at_src_ballet_ed25519_at_x25519_h */