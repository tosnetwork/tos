...
- Add a chain-wide contract indexer, closing `GET /tasks`'s original "local registry only"
  ...
  wallet index described in [`tos-wc0-wallet-index.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-wc0-wallet-index.md) -- that hooks directly into
  ...
  Reorgs are a real, documented hazard on this chain ([`tos-message-policy.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md)'s
  replay-across-reorgs note, [`tos-time-policy.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-time-policy.md)'s scheduled-entry rollback
...
- Add workflow examples that compose planner, worker, service and verifier actors: see
  [`ai-agent-workflow-example.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/ai-agent-workflow-example.md), which walks a
...
- Publish reference schemas for result metadata and evidence bundles: see
  [`ai-workflow-schemas.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/ai-workflow-schemas.md) -- a canonical-JSON-plus-SHA-256
...
- Add [`ai-actors.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/ai-actors.md) to describe the actor-model architecture for AI agents.
- Add [`agent-wallet-mvp.md`](https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/agent-wallet-mvp.md) to define the first local Agent Wallet slice.
