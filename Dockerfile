...
COPY --from=builder /ton/build/toslib/libtoslibjson.so /usr/local/bin/
...
COPY --from=builder /ton/crypto/smartcont/* /usr/share/tos/smartcont/
COPY --from=builder /ton/crypto/smartcont/auto/* /usr/share/tos/smartcont/auto/
