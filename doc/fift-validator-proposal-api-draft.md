...
| `config-vote-ext-msg` | `( wc addr signature to-sign -- c )` | Build the external message carrying a signed config vote. | [`config-proposal-vote-signed.fif`](../crypto/smartcont/config-proposal-vote-signed.fif) |
