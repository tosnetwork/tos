...
| Inject a second identical `FinalizationObserved` 0.2 s after the first, inside the settle window | exit 1, `events=2 mismatch=0 accept_calls=0` | `n5-cut4-repeat-event-mutant.patch`: `444b53523dcab65ca9afd24051f12fd2adc30a612b95b5e54a343d2c31a02a0b` | `9108a458351fb7243714db8d6efef83ef4ddeb1623434231093aee03d7089363` / `e5be2be6469a93649606b79a5575d2165e1c72d7c9877406fbe8ca65996e2874` / `6dc95aa1281ff241fc7a2d8bf4fdcc922faea77a0b0c0522aa7d7af54430063e` |
