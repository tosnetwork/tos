...
Status: **N01 RESOLVED within owner O-4's controlled single-machine actor/DB scope**, signed off in memo/main `4946db6b` after Mac's independent review and exact pushed `0f104caee1a1ae0f745361351b379d6e0bb2d651` Branch PQ/Python run `36066590519` (named continuation 1/1) and Source guards run `36066590546`, both successful. The actor/DB implementation source is `e0923941d799cfdca47fac0a2de268eb9fddb46f`. N02–N07 retain their separately scoped sign-offs. This is an orderly, controlled process stop, not SIGKILL, power-loss atomicity, a live node network, or cross-node recovery.
...
Both registration mutations were reconstructed as single-file patches against `0f104caee` with `git apply --check`, and their exact exit wrappers are retained under `test/integration/.n5-manager-db-fixture-20260924/`: `n01-no-ctest-guard-mutant.patch` SHA-256 `91ded98a81f94c12f1623601c0d6fcd681395f2cc36c992984d5641960f3ab7b`, exit wrapper `9acb01ab3578b2f3ce87bce784ba647378ee91f2c4cd77415a2cacc617fbd960`; `n01-no-workflow-guard-mutant.patch` SHA-256 `59583ced6a2bc1a3cd4017cda4348a7afa729e863bbd6e74e1c79876ff2468a7`, exit wrapper `41381b65f4103a7dd19a19cf5ef4a7038d4ee13a3549bc16371e32f701069f71`. The clean guard exited 0 after each restoration, and the tracked worktree was clean.
...
The retained [clean exit wrapper](../../test/integration/.n5-manager-db-fixture-20260924/e0923941d-continuation.exit.log) is SHA-256 `11b3dbc81163911634a2be30e76a1d9140fc0799630730290cc1e6dcd743b8c6`; the [mutant exit wrapper](../../test/integration/.n5-manager-db-fixture-20260924/e0923941d-seq2-next-mutant.exit.log) is `46b613b7e513a5bd0562af5762abba288729878eb5811a777123f6d0b39ba900`. Each records the exact command, process exit code, test/production source, retained binary, and raw-log hashes. The mutant's status `256` printed by its parent is the child wait status for exit 1, not a separate error classification.
