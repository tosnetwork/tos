...
| `crypto/test/test-smartcont.cpp` | Loads both base Fift tools and the test-only single-pool legacy fixture; its green byte regression is not PQ acceptance. T07 handles the remaining base-tool dependency. |
