...
| `crypto/test/test-smartcont.cpp` | Loads both base Fift tools and the test-only single-pool and liquid-controller legacy fixtures; its green byte regression is not PQ acceptance. T07 handles the remaining base-tool dependency. |
