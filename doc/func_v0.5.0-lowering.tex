...
\subsection{\texttt{require!} and Abort Lowering}
\label{sec:lower-require}
The main failure mechanism in FunC \verb|0.5.0| is abort. The source
construct \verb|require!(cond, Err)| lowers to:

\begin{verbatim}
if !(cond) { THROW(Err as u16) }
\end{verbatim}

That is a single \verb|IFNOT| conditional around the TVM
...
immediate-operand form when available.
