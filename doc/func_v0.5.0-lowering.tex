...
\item typed-\verb|Err|-to-exit-code mapping: main-spec Canonical Decision 5;
\item getter / \verb|method_id| selector policy: main-spec Canonical
Decision 6;
\item expression grammar and operator precedence: main-spec Canonical
Decision 7;
\item trait coherence and orphan rules: main-spec Canonical Decision 8;
\item eager-decode opt-in syntax for \verb|entry external|: main-spec
Canonical Decision 9;
