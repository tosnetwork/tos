...
TOS Network's actor-model architecture -- described in full in
\texttt{doc/tos.tex} and in the project's \texttt{ROADMAP.md} -- was built to answer that need
...
\texttt{doc/security-audit-native-2026-06.md} still explicitly excludes these AI-actor
...
(\texttt{tos-protocol}) and independently operated AI Edge Computing Terminals
