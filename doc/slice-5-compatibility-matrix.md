...
| Oracle | `doc/slice5-abi-manifests/oracle.json` | `doc/slice4-behaviours/slice5_oracle.json` | `examples/slice5/oracle-scaffold/` | `slice5-oracle-stdlib-positive.tol` | Pending |
...
`doc/slice-5-abi-freeze-record.json`.
