...
repo=Path('/home/tomi/tos-m2'); out=repo/'doc/measurements/uno-m1-activation-context-9f6e93a25'
out.mkdir(exist_ok=False)
source='crypto/test/workchain-activation-context.py'; original=(repo/source).read_bytes()
...
for identity in [*range(303,315), 316]:
...
print('13 isolated context controls restored; resolver observations recorded; shared classification pending')
