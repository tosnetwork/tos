...
run('install',['gdb','-q','-batch','-x','/tmp/uno-d40-postzero/typed-install.gdb','--args',b/'test-tos-collator','-C',d/'global.json','-D',d/'db','--query-result',d/'install.result','-w',-1,'-m',d/'message-12.boc','-m',d/'message-84.boc'])
