...
\verb|Option<T>| is bit-compatible with TL-B \verb|Maybe X|; \verb|Result<T,
E>| uses a 1-bit tag. See Sections~\ref{sec:cd-stack-enum} and
\ref{sec:cd-wire-enum}.
...
\verb|ctx.body_slice: Slice| and a user-invoked \verb|ctx.parse_body<T>()
-> Result<T, ParseError>|. The wrapper does \emph{not} decode eagerly,
...
10 & \verb|<<|  \verb|>>| & left \\ \hline
 ...
 4 & \verb|{|}\verb|{|} & left (short-circuit) \\ \hline
