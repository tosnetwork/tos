...
APIs. Free functions may also accept mutable places explicitly:
...
When \verb|body_layout| is \verb|Auto|, the compiler or stdlib may inline small
message bodies and spill larger ones to a ref automatically. This reflects real
TVM ergonomics: source code should express intent, while the message builder
chooses the cheapest valid encoding unless the author overrides it.
