...
\textbf{Artificial Intelligence Proof of Work (AIPoW)}. AIPoW is a direct extension of the proof-of-work
...
on an arbitrary puzzle, a AIPoW participant proves completed, evidence-graded, on-chain
...
by staked validators; AIPoW secures and provisions the service-capacity layer --- the real
...
AIPoW rewards are scored per epoch from settled work only:
...
Like validator rewards, AIPoW tokens are created by the protocol at distribution time and
...
AIPoW is a specified design with published launch gates, including security review of the
