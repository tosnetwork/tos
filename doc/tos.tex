...
\begin{itemize}
  ...
  \item defined discovery, relay, verification or storage services;
...
Service transaction volume, validator fees, protocol revenue and token value accrual are
distinct concepts. This paper makes no forecast or promise regarding any of them. Detailed
monetary policy, incentives, fee routing and governance require separate specifications and
