...
class QuicTester : public td::actor::Actor {
 public:
  class Callback : public tos::quic::QuicServer::Callback {
   public:
  ...
  void on_connected(tos::quic::QuicConnectionId cid) {
    ...
    send_closure(server_, &tos::quic::QuicServer::send_stream, cid,
                 std::variant<tos::quic::QuicStreamID, tos::quic::StreamOptions>{tos::quic::StreamOptions{}},
                 td::BufferSlice("GET /\r\n"), true);
  }
