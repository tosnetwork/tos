...
td::Result<DhtKey> DhtKey::create(tl_object_ptr<tos_api::dht_key> key) {
...
tl_object_ptr<tos_api::dht_key> DhtKey::tl() const {
  return create_tl_object<tos_api::dht_key>(id_.tl(), td::BufferSlice{namestr_}, idx_);
}
...
tl_object_ptr<tos_api::dht_keyDescription> DhtKeyDescription::tl() const {
  return create_tl_object<tos_api::dht_keyDescription>(key_.tl(), public_key_.tl(), update_rule_->tl(),
                                                       signature_.clone_as_buffer_slice());
}

td::BufferSlice DhtKeyDescription::to_sign() const {
  return create_serialize_tl_object<tos_api::dht_keyDescription>(key_.tl(), public_key_.tl(), update_rule_->tl(),
                                                                 td::BufferSlice());
}
...
td::Result<DhtKeyDescription> DhtKeyDescription::create(tl_object_ptr<tos_api::dht_keyDescription> desc,
...
td::Result<DhtValue> DhtValue::create(tl_object_ptr<tos_api::dht_value> obj, bool check_signature) {
...
tl_object_ptr<tos_api::dht_value> DhtValue::tl() const {
  return create_tl_object<tos_api::dht_value>(key_.tl(), value_.clone_as_buffer_slice(), ttl_,
                                              signature_.clone_as_buffer_slice());
}

td::BufferSlice DhtValue::to_sign() const {
  return create_serialize_tl_object<tos_api::dht_value>(key_.tl(), value_.clone_as_buffer_slice(), ttl_,
                                                        td::BufferSlice());
}
...
tl_object_ptr<tos_api::dht_UpdateRule> DhtUpdateRuleSignature::tl() const {
  return create_tl_object<tos_api::dht_updateRule_signature>();
}
...
tl_object_ptr<tos_api::dht_UpdateRule> DhtUpdateRuleAnybody::tl() const {
  return create_tl_object<tos_api::dht_updateRule_anybody>();
}
...
td::Status DhtUpdateRuleOverlayNodes::check_value(const DhtValue &value) {
  ...
  auto F = fetch_tl_object<tos_api::overlay_nodes>(value.value().clone_as_buffer_slice(), true);
  if (F.is_error()) {
...
td::Status DhtUpdateRuleOverlayNodes::update_value(DhtValue &value, DhtValue &&new_value) {
  TRY_RESULT_PREFIX(N, fetch_tl_object<tos_api::overlay_nodes>(value.value().clone_as_buffer_slice(), true),
                    "bad dht value in updateRule.overlayNodes: ");
  TRY_RESULT_PREFIX(L, fetch_tl_object<tos_api::overlay_nodes>(new_value.value().clone_as_buffer_slice(), true),
                    "bad dht value in updateRule.overlayNodes: ");
  ...
  auto nodes = create_serialize_tl_object<tos_api::overlay_nodes>(std::move(vec));
...
tl_object_ptr<tos_api::dht_UpdateRule> DhtUpdateRuleOverlayNodes::tl() const {
  return create_tl_object<tos_api::dht_updateRule_overlayNodes>();
}
...
td::Result<std::shared_ptr<DhtUpdateRule>> DhtUpdateRule::create(tl_object_ptr<tos_api::dht_UpdateRule> obj) {
  td::Result<std::shared_ptr<DhtUpdateRule>> R;
  tos_api::downcast_call(
      *obj.get(),
      td::overloaded([&](tos_api::dht_updateRule_signature &obj) { R = DhtUpdateRuleSignature::create(); },
                     [&](tos_api::dht_updateRule_anybody &obj) { R = DhtUpdateRuleAnybody::create(); },
                     [&](tos_api::dht_updateRule_overlayNodes &obj) { R = DhtUpdateRuleOverlayNodes::create(); }));
  return R;
}
