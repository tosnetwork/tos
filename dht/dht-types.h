...
class DhtKey {
 public:
  ...
  static td::Result<DhtKey> create(tl_object_ptr<tos_api::dht_key> key);
  ...
  tl_object_ptr<tos_api::dht_key> tl() const;
...
class DhtUpdateRule {
 public:
  ...
  virtual tl_object_ptr<tos_api::dht_UpdateRule> tl() const = 0;
  static td::Result<std::shared_ptr<DhtUpdateRule>> create(tl_object_ptr<tos_api::dht_UpdateRule> obj);
};
...
class DhtKeyDescription {
 public:
  ...
  td::Status check() const;
  tl_object_ptr<tos_api::dht_keyDescription> tl() const;
  DhtKeyDescription clone() const;
  static td::Result<DhtKeyDescription> create(tl_object_ptr<tos_api::dht_keyDescription> desc, bool check_signature);
...
class DhtValue {
 public:
  ...
  static td::Result<DhtValue> create(tl_object_ptr<tos_api::dht_value> obj, bool check_signature);
  ...
  tl_object_ptr<tos_api::dht_value> tl() const;
  td::BufferSlice to_sign() const;
...
class DhtUpdateRuleSignature : public DhtUpdateRule {
 public:
  ...
  tl_object_ptr<tos_api::dht_UpdateRule> tl() const override;
...
inline td::StringBuilder &operator<<(td::StringBuilder &sb, const tos::dht::DhtKeyId &dht) {
  sb << dht.tl();
  return sb;
}
