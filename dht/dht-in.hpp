...
class DhtMemberImpl : public DhtMember {
 private:
  ...
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_ping &query, td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_findNode &query, td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_findValue &query, td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_store &query, td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_getSignedAddressList &query,
                     td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_registerReverseConnection &query,
                     td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::dht_requestReversePing &query,
                     td::Promise<td::BufferSlice> promise);
