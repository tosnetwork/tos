...
td::Status GetTimeQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getTime>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetTimeQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_time>(std::move(data), true),
...
td::Status NewKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_generateKeyPair>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status NewKeyQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_keyHash>(std::move(data), true),
                    "received incorrect answer: ");
...
td::Status ImportPrivateKeyFileQuery::send() {
  ...
  TRY_RESULT(pk, tos::PrivateKey::import(data.as_slice()));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_importPrivateKey>(pk.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ExportPublicKeyQuery::run() {
  TRY_RESULT_ASSIGN(key_hash_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_STATUS(tokenizer_.check_endl());
  return td::Status::OK();
}

td::Status ExportPublicKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_exportPublicKey>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status ExportPublicKeyQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::PublicKey>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_sign>(key_hash_.tl(), std::move(data_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status SignQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_signature>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignFileQuery::send() {
  ...
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_sign>(key_hash_.tl(), std::move(data));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ExportAllPrivateKeysQuery::run() {
  ...
  TRY_STATUS(tokenizer_.check_endl());
  client_pk_ = tos::privkeys::Ed25519::random();
  return td::Status::OK();
}

td::Status ExportAllPrivateKeysQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_exportAllPrivateKeys>(
...
td::Status ExportAllPrivateKeysQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_exportedPrivateKeys>(data.as_slice(), true),
                    "received incorrect answer: ");
  ...
  std::vector<tos::PrivateKey> private_keys;
  while (!slice.empty()) {
    if (slice.size() < 4) {
    ...
    TRY_RESULT_PREFIX(private_key, tos::PrivateKey::import(slice.substr(0, size)), "cannot parse private key: ");
  ...
  for (const tos::PrivateKey &private_key : private_keys) {
...
td::Status AddAdnlAddrQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addAdnlId>(key_hash_.tl(), category_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddDhtIdQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addDhtId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddValidatorPermanentKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addValidatorPermanentKey>(
...
td::Status AddValidatorTempKeyQuery::run() {
  TRY_RESULT_ASSIGN(perm_key_hash_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(key_hash_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(expire_at_, tokenizer_.get_token<td::uint32>());
  TRY_STATUS(tokenizer_.check_endl());
  return td::Status::OK();
...
td::Status AddValidatorTempKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addValidatorTempKey>(
...
td::Status ChangeFullNodeAdnlAddrQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_changeFullNodeAdnlAddress>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddValidatorAdnlAddrQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addValidatorAdnlAddress>(
      perm_key_hash_.tl(), key_hash_.tl(), expire_at_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddLiteServerQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addLiteserver>(key_hash_.tl(), port_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelAdnlAddrQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delAdnlId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelDhtIdQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delDhtId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorPermanentKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delValidatorPermanentKey>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorTempKeyQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delValidatorTempKey>(perm_key_hash_.tl(),
                                                                                               key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorAdnlAddrQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delValidatorAdnlAddress>(perm_key_hash_.tl(),
                                                                                                   key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetConfigQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getConfig>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetConfigQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_jsonConfig>(data.as_slice(), true),
                    "received incorrect answer: ");
  td::TerminalIO::out() << "---------\n" << f->data_ << "--------\n";
  return td::Status::OK();
}
...
td::Status SetVerbosityQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setVerbosity>(verbosity_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetStatsQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status AddNetworkAddressQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addListeningPort>(
...
td::Status DelNetworkAddressQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delListeningPort>(
      static_cast<td::int32>(addr_.get_ipv4()), addr_.get_port(), std::move(cats_), std::move(prio_cats_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddNetworkProxyAddressQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addProxy>(
      static_cast<td::int32>(in_addr_.get_ipv4()), in_addr_.get_port(), static_cast<td::int32>(out_addr_.get_ipv4()),
      out_addr_.get_port(), tos::create_tl_object<tos::tos_api::adnl_proxy_fast>(id_, std::move(shared_secret_)),
...
td::Status AddQuicAddressQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addQuicAddr>(
      static_cast<td::int32>(addr_.get_ipv4()), addr_.get_port(), std::move(cats_), std::move(prio_cats_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelQuicAddressQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delQuicAddr>(
      static_cast<td::int32>(addr_.get_ipv4()), addr_.get_port(), std::move(cats_), std::move(prio_cats_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status CreateProposalVoteQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_createProposalVote>(td::BufferSlice(data_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status CreateComplaintVoteQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_createComplaintVote>(election_id_,
...
td::Status CheckDhtServersQuery::run() {
  TRY_RESULT_ASSIGN(id_, tokenizer_.get_token<tos::PublicKeyHash>());
  return td::Status::OK();
}

td::Status CheckDhtServersQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_checkDhtServers>(id_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status CheckDhtServersQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_dhtServersStatus>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignCertificateQuery::run() {
  ...
  TRY_RESULT_ASSIGN(signer_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(out_file_, tokenizer_.get_token<std::string>());
  return td::Status::OK();
}

td::Status SignCertificateQuery::send() {
  auto cid = tos::create_serialize_tl_object<tos::tos_api::overlay_certificateId>(overlay_, id_, expire_at_, max_size_);
  auto sign = tos::create_serialize_tl_object<tos::tos_api::engine_validator_sign>(signer_.tl(), std::move(cid));
  auto pub = tos::create_serialize_tl_object<tos::tos_api::engine_validator_exportPublicKey>(signer_.tl());
...
void SignCertificateQuery::receive_pubkey(td::BufferSlice R) {
  auto f = tos::fetch_tl_object<tos::tos_api::PublicKey>(R.as_slice(), true);
  if (f.is_error()) {
...
void SignCertificateQuery::receive_signature(td::BufferSlice R) {
  auto f = tos::fetch_tl_object<tos::tos_api::engine_validator_signature>(R.as_slice(), true);
  if (f.is_error()) {
...
void SignCertificateQuery::save_certificate() {
  auto c = tos::create_serialize_tl_object<tos::tos_api::overlay_certificate>(std::move(pubkey_), expire_at_, max_size_,
                                                                              std::move(signature_));
...
td::Status ImportCertificateQuery::run() {
  TRY_RESULT_ASSIGN(overlay_, tokenizer_.get_token<td::Bits256>());
  TRY_RESULT_ASSIGN(id_, tokenizer_.get_token<td::Bits256>());
  TRY_RESULT_ASSIGN(kh_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(in_file_, tokenizer_.get_token<std::string>());
  return td::Status::OK();
}
...
td::Status ImportCertificateQuery::send() {
  TRY_RESULT(data, td::read_file(in_file_));
  TRY_RESULT_PREFIX(cert, tos::fetch_tl_object<tos::tos_api::overlay_Certificate>(data.as_slice(), true),
                    "incorrect certificate");
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_importCertificate>(
      overlay_, tos::create_tl_object<tos::tos_api::adnl_id_short>(id_),
      tos::create_tl_object<tos::tos_api::engine_validator_keyHash>(kh_.tl()), std::move(cert));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetOverlaysStatsQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getOverlaysStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetOverlaysStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_overlaysStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  for (auto &s : f->overlays_) {
    ...
    auto print_traffic = [&](const char *name, const char *indent,
                             tos::tl_object_ptr<tos::tos_api::engine_validator_overlayStatsTraffic> &t) {
      sb << indent << name << ":\n"
...
td::Status SignShardOverlayCertificateQuery::run() {
  TRY_RESULT_ASSIGN(shard_, tokenizer_.get_token<tos::ShardIdFull>());
  TRY_RESULT_ASSIGN(key_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(expire_at_, tokenizer_.get_token<td::int32>());
  TRY_RESULT_ASSIGN(max_size_, tokenizer_.get_token<td::uint32>());
  TRY_RESULT_ASSIGN(out_file_, tokenizer_.get_token<std::string>());
...
td::Status SignShardOverlayCertificateQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_signShardOverlayCertificate>(
      shard_.workchain, shard_.shard, tos::create_tl_object<tos::tos_api::engine_validator_keyHash>(key_.tl()),
...
td::Status SignShardOverlayCertificateQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(c, tos::fetch_tl_object<tos::tos_api::overlay_certificate>(data.as_slice(), true),
...
td::Status ImportShardOverlayCertificateQuery::send() {
  ...
  TRY_RESULT_PREFIX(cert, tos::fetch_tl_object<tos::tos_api::overlay_Certificate>(data.as_slice(), true),
                    "incorrect certificate");
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_importShardOverlayCertificate>(
      shard_.workchain, shard_.shard, tos::create_tl_object<tos::tos_api::engine_validator_keyHash>(key_.tl()),
      std::move(cert));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
...
td::Status GetActorStatsQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getActorTextStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetActorStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_textStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  if (file_name_.empty()) {
...
td::Status GetPerfTimerStatsJsonQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getPerfTimerStats>("");
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetPerfTimerStatsJsonQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_perfTimerStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  std::ofstream sb(file_name_);
...
td::Status GetShardOutQueueSizeQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getShardOutQueueSize>(
      dest_.is_valid() ? 1 : 0, tos::create_tl_block_id_simple(block_id_), dest_.workchain, dest_.shard);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetShardOutQueueSizeQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_shardOutQueueSize>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SetExtMessagesBroadcastDisabledQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setExtMessagesBroadcastDisabled>(value);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddCustomOverlayQuery::send() {
  ...
  auto overlay = tos::create_tl_object<tos::tos_api::engine_validator_customOverlay>();
  TRY_STATUS(tos::tos_api::from_json(*overlay, json.get_object()));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addCustomOverlay>(std::move(overlay));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelCustomOverlayQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delCustomOverlay>(name_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ShowCustomOverlaysQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_showCustomOverlays>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status ShowCustomOverlaysQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::engine_validator_customOverlaysConfig>(data.as_slice(), true),
                    "received incorrect answer: ");
  ...
  for (const auto &overlay : f->overlays_) {
    ...
    if (!overlay->sender_shards_.empty()) {
      ...
      for (const auto &shard : overlay->sender_shards_) {
        td::TerminalIO::out() << "  " << tos::create_shard_id(shard).to_str() << "\n";
      }
    }
...
td::Status SetStateSerializerEnabledQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setStateSerializerEnabled>(enabled_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status SetCollatorOptionsJsonQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  auto b =
      tos::create_serialize_tl_object<tos::tos_api::engine_validator_setCollatorOptionsJson>(data.as_slice().str());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ResetCollatorOptionsQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setCollatorOptionsJson>("{}");
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetCollatorOptionsJsonQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getCollatorOptionsJson>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetAdnlStatsJsonQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getAdnlStats>(all_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetAdnlStatsJsonQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::adnl_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status GetAdnlStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(stats, tos::fetch_tl_object<tos::tos_api::adnl_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
  td::StringBuilder sb;
  sb << "================================= ADNL STATS =================================\n";
  bool first = true;
  ...
  for (auto &local_id : stats->local_ids_) {
    ...
    if (!local_id->current_decrypt_.empty()) {
      std::sort(
          ...
          [](const tos::tl_object_ptr<tos::tos_api::adnl_stats_ipPackets> &a,
             const tos::tl_object_ptr<tos::tos_api::adnl_stats_ipPackets> &b) { return a->packets_ > b->packets_; });
      td::uint64 total = 0;
    ...
    auto print_local_id_packets = [&](const std::string &name,
                                      std::vector<tos::tl_object_ptr<tos::tos_api::adnl_stats_ipPackets>> &vec) {
      if (vec.empty()) {
        return;
      }
      std::sort(
    ...
    std::sort(local_id->peers_.begin(), local_id->peers_.end(),
              [](const tos::tl_object_ptr<tos::tos_api::adnl_stats_peerPair> &a,
                 const tos::tl_object_ptr<tos::tos_api::adnl_stats_peerPair> &b) {
    ...
    for (auto &peer : local_id->peers_) {
      ...
      auto print_packets = [&](const std::string &name,
                               const tos::tl_object_ptr<tos::tos_api::adnl_stats_packets> &obj) {
        if (obj->in_packets_) {
...
td::Status AddShardQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addShard>(tos::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelShardQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delShard>(tos::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddCollatorQuery::run() {
  TRY_RESULT_ASSIGN(adnl_id_, tokenizer_.get_token<tos::PublicKeyHash>());
  TRY_RESULT_ASSIGN(shard_, tokenizer_.get_token<tos::ShardIdFull>());
  return td::Status::OK();
}

td::Status AddCollatorQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addCollator>(adnl_id_.tl(),
                                                                                       tos::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelCollatorQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delCollator>(adnl_id_.tl(),
                                                                                       tos::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status CollatorNodeAddWhitelistedValidatorQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_collatorNodeSetWhitelistedValidator>(
...
td::Status CollatorNodeEnableWhitelistQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_collatorNodeSetWhitelistEnabled>(enabled_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status CollatorNodeShowWhitelistQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_showCollatorNodeWhitelist>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status CollatorNodeShowWhitelistQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f,
                    tos::fetch_tl_object<tos::tos_api::engine_validator_collatorNodeWhitelist>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SetCollatorsListQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  TRY_RESULT(json, td::json_decode(data.as_slice()));
  auto list = tos::create_tl_object<tos::tos_api::engine_validator_collatorsList>();
  TRY_STATUS(tos::tos_api::from_json(*list, json.get_object()));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setCollatorsList>(std::move(list));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ClearCollatorsListQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_clearCollatorsList>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ShowCollatorsListQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_showCollatorsList>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status ShowCollatorsListQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(list, tos::fetch_tl_object<tos::tos_api::engine_validator_collatorsList>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status GetCollationManagerStatsQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getCollationManagerStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetCollationManagerStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(list,
                    tos::fetch_tl_object<tos::tos_api::engine_validator_collationManagerStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  ...
  for (auto &stats : list->local_ids_) {
    ...
    std::map<td::Bits256, tos::tos_api::engine_validator_collationManagerStats_collator *> collators;
...
td::Status SignOverlayMemberCertificateQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_signOverlayMemberCertificate>(
...
td::Status SignOverlayMemberCertificateQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, tos::fetch_tl_object<tos::tos_api::overlay_MemberCertificate>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status ImportFastSyncMemberCertificateQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  TRY_RESULT(certificate, tos::fetch_tl_object<tos::tos_api::overlay_MemberCertificate>(data, true));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_importFastSyncMemberCertificate>(
...
td::Status AddFastSyncOverlayClientQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_addFastSyncClient>(adnl_id_, slot_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelFastSyncOverlayClientQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_delFastSyncClient>(adnl_id_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status SetShardBlockVerifierConfigQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  TRY_RESULT(json, td::json_decode(data.as_slice()));
  auto list = tos::create_tl_object<tos::tos_api::engine_validator_shardBlockVerifierConfig>();
  TRY_STATUS(tos::tos_api::from_json(*list, json.get_object()));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setShardBlockVerifierConfig>(std::move(list));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ShowShardBlockVerifierConfigQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_showShardBlockVerifierConfig>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ShowShardBlockVerifierConfigQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(
      config, tos::fetch_tl_object<tos::tos_api::engine_validator_shardBlockVerifierConfig>(data.as_slice(), true),
      "received incorrect answer: ");
...
td::Status SetConsensusNoncriticalParamsOverridesQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  TRY_RESULT(json, td::json_decode(data.as_slice()));
  auto list = tos::create_tl_object<tos::tos_api::consensus_noncriticalParamsOverrideList>();
  TRY_STATUS(tos::tos_api::from_json(*list, json.get_object()));
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_setConsensusNoncriticalParamsOverrides>(
      std::move(list));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetConsensusNoncriticalParamsOverridesQuery::send() {
  auto b = tos::create_serialize_tl_object<tos::tos_api::engine_validator_getConsensusNoncriticalParamsOverrides>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetConsensusNoncriticalParamsOverridesQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(result,
                    tos::fetch_tl_object<tos::tos_api::consensus_noncriticalParamsOverrideList>(data.as_slice(), true),
                    "received incorrect answer: ");
