...
//
// References:
//   - https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md v5 (Approved 2026-04-29)
...
//              row.
//   - https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/GlobalVersions.md §"Version 12" — canonical TL-B for
...
// pattern (see `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md` emulator-semantics
...
// internal messages. See `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md` emulator-semantics
...
// ---------------------------------------------------------------------------
//
// Scenario per `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md` §6.2 paragraph after the
...
// ---------------------------------------------------------------------------
//
// Scenario per `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md` §2.2 second bullet:
//
...
// ---------------------------------------------------------------------------
//
// Scenario per `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md` §2.2 third bullet:
//
//   "`2` — action phase failed."
//
