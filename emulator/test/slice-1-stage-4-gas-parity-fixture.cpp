...
//
// References:
//   - https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md §8.1 — bit-identical wire commitment that
//     makes the inbound bytes the same for both sides.
//   - https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md §10.1 — ≤ 15% bytecode budget the ratio
//     gate enforces in the gas dimension.
//   - https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-envelope-migration.md — bytecode-cell ratios per
...
// Tol 22 = 1.10 per `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-envelope-migration.md` (the only
...
//
// Per `https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-envelope-migration.md` the bytecode-cell ratio
