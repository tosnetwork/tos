...
//
// Cite: https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md v5 §3.4 (current valid mask is `& 3`)
...
//
// Cite: https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md v5 §3.4 -- "Bits 2 and 3 are reserved by
...
//
// Cite: https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md v5 §3.4 "Synchronized constants" --
...
static_assert(tol::EXTRA_FLAGS_VALID_MASK == 3,
              ...
              "-- see https://github.com/tosnetwork/constitution/blob/main/tos-blockchain/tos-message-policy.md v5 §3.4.");
