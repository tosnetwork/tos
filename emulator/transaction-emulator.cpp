...
td::Result<std::unique_ptr<TransactionEmulator::EmulationResult>> TransactionEmulator::emulate_transaction(
    block::Account&& account, td::Ref<vm::Cell> msg_root, tos::UnixTime utime, tos::LogicalTime lt, int trans_type) {
...
td::Result<std::unique_ptr<block::transaction::Transaction>> TransactionEmulator::create_transaction(
    td::Ref<vm::Cell> msg_root, block::Account* acc, tos::UnixTime utime, tos::LogicalTime lt, int trans_type,
...
void TransactionEmulator::set_unixtime(tos::UnixTime unixtime) {
  unixtime_ = unixtime;
}

void TransactionEmulator::set_lt(tos::LogicalTime lt) {
  lt_ = lt;
}
