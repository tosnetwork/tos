...
class ToslibEventLoop:
    def __init__(
        ...
        self._toslib = toslib
        self._loop = toslib.event_loop_create(threads)
    ...
    def close(self) -> None:
        ...
        try:
            ...
            self._toslib.event_loop_cancel(self._loop)
            ...
            self._toslib.event_loop_destroy(self._loop)
            self._loop = 0
    ...
    def _poll_loop(self) -> None:
        try:
            while not self._cancelled:
                continuation = self._toslib.event_loop_wait(self._loop, 60.0)
