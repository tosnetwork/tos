...
class ToslibCDLL:
    def __init__(self, cdll_path: Path):
        toslib = ctypes.CDLL(cdll_path)

        client_set_verbosity_level = toslib.toslib_client_set_verbosity_level
        ...
        event_loop_create = toslib.toslib_event_loop_create
        ...
        event_loop_destroy = toslib.toslib_event_loop_destroy
        ...
        event_loop_cancel = toslib.toslib_event_loop_cancel
        ...
        event_loop_wait = toslib.toslib_event_loop_wait
        ...
        engine_console_create = toslib.toslib_engine_console_create
        ...
        engine_console_destroy = toslib.toslib_engine_console_destroy
        ...
        engine_console_is_error = toslib.toslib_engine_console_is_error
        ...
        engine_console_get_error_code = toslib.toslib_engine_console_get_error_code
        ...
        engine_console_get_error_message = toslib.toslib_engine_console_get_error_message
        ...
        engine_console_request = toslib.toslib_engine_console_request
        ...
        response_destroy = toslib.toslib_response_destroy
        ...
        response_await_ready = toslib.toslib_response_await_ready
        ...
        response_await_suspend = toslib.toslib_response_await_suspend
        ...
        response_is_error = toslib.toslib_response_is_error
        ...
        response_get_error_code = toslib.toslib_response_get_error_code
        ...
        response_get_error_message = toslib.toslib_response_get_error_message
        ...
        response_get_response = toslib.toslib_response_get_response
        ...
        client_json_create = toslib.toslib_client_json_create
        ...
        client_json_send = toslib.toslib_client_json_send
        ...
        client_json_receive = toslib.toslib_client_json_receive
        ...
        client_json_cancel_requests = toslib.toslib_client_json_cancel_requests
        ...
        client_json_destroy = toslib.toslib_client_json_destroy
