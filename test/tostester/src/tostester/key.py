...
@dataclass
class Key:
    private_key: tos_api.Pk_ed25519
    public_key: tos_api.Pub_ed25519
    short_key: tos_api.Adnl_id_short
    ...
    def new(install: Install) -> "Key":
        ...
        return Key(
            private_key=tos_api.Pk_ed25519.from_json(parts[0].decode()),
            public_key=tos_api.Pub_ed25519.from_json(parts[1].decode()),
            short_key=tos_api.Adnl_id_short.from_json(parts[2].decode()),
        )
