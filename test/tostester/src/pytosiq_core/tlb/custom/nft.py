...
class NftItemSaleFees(TlbScheme):
    """
    nft_item_sale_fees#_ marketplace_fee_address:Address marketplace_fee:Tomis royalty_address:Address royalty_amount:Tomis = NftItemSaleFees;
    """
    def __init__(self,
...
class NftItemSaleData(TlbScheme):
    """
    nft_item_sale_data#_ is_complete:bool created_at:uint32 marketplace_address:Address nft_address:Address nft_owner_address:Address full_price:tomis fees_cell:^NftItemSaleFees can_deploy_by_external:bool = NftItemSaleData;
    """
    def __init__(self,
