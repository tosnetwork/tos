...
class ConfigParam6(TlbScheme):
    """
    _ mint_new_price:Tomis mint_add_price:Tomis = ConfigParam 6;
    """
...
class BlockCreateFees(TlbScheme):
    """
    block_tomis_created#6b masterchain_block_fee:Tomis basechain_block_fee:Tomis
    = BlockCreateFees;
    """
    def __init__(self,
...
class ConfigParam17(TlbScheme):
    """
    _ min_stake:Tomis max_stake:Tomis min_total_stake:Tomis max_stake_factor:uint32 = ConfigParam 17;
    """
    def __init__(self,
                 min_stake: int,
                 max_stake: int,
