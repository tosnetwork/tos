...
int main() {
  ...
  auto decode_encode = [](auto obj_json) {
    ...
    tos::tos_api::object_ptr<tos::tos_api::Object> obj2;
  ...
  td::Bits256 uint256;
  uint256.set_ones();
  test_tl_json(tos::tos_api::make_object<tos::tos_api::adnl_id_short>(uint256));

  test_tl_json(tos::tos_api::make_object<tos::tos_api::testObject>(
      1, tos::tos_api::make_object<tos::tos_api::adnl_id_short>(uint256),
      tos::tos_api::make_object<tos::tos_api::getTestObject>()));
  ...
  auto decode_encode_local = [](auto obj_json) {
    auto as_json_value = td::json_decode(obj_json).move_as_ok();
    tos::tos_api::config_local config_local;
  ...
  test_tl_json(tos::tos_api::make_object<tos::tos_api::testVectorBytes>(create_vector_bytes()));
