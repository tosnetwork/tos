...
def main():
    p=argparse.ArgumentParser();p.add_argument('vectors',type=Path);p.add_argument('out',type=Path);a=p.parse_args()
    rows=[];good=None
    def add(name,cells,version=16,budget=1_000_000,ignore=0,repeats=1,expected=''):
