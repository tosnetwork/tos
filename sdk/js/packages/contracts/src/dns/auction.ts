 ...
 * crypto/smartcont/dns/func (nft-item.fc, dns-utils.fc). These reproduce the
...
export const MIN_STORAGE_RESERVE = ONE_TOS; // min storage reserve kept by the item

/** Minimum-price tiers: (start, end) whole-token amounts by label byte length. */
...
export interface DnsAuctionInfo {
