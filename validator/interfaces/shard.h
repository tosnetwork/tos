...
class MasterchainState : virtual public ShardState {
 public:
  ...
  virtual BlockSeqno get_vertical_seqno() const = 0;
  ...
  virtual bool get_old_mc_block_id(tos::BlockSeqno seqno, tos::BlockIdExt& blkid,
                                   tos::LogicalTime* end_lt = nullptr) const = 0;
  virtual bool check_old_mc_block_id(const tos::BlockIdExt& blkid, bool strict = false) const = 0;
