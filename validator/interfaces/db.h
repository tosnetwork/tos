...
class Db : public td::actor::Actor {
 public:
  ...
  virtual void get_block_candidate(tos::PublicKey source, BlockIdExt id, FileHash collated_data_file_hash,
  ...
  virtual void mark_validator_auth_session_store_provisioned(td::Promise<td::Unit> promise) = 0;
  virtual void get_validator_auth_session_store_provisioned(td::Promise<bool> promise) = 0;
