...
struct StorageStatCacheStats {
  ...
  tl_object_ptr<tos_api::validatorStats_storageStatCacheStats> tl() const {
    return create_tl_object<tos_api::validatorStats_storageStatCacheStats>(small_cnt, small_cells, hit_cnt, hit_cells,
                                                                           miss_cnt, miss_cells);
  }
};
...
struct CollationStats {
  ...
  struct NeighborStats {
    ...
    tl_object_ptr<tos_api::validatorStats_blockStats_neighborStats> tl() const {
      return create_tl_object<tos_api::validatorStats_blockStats_neighborStats>(
  ...
  tl_object_ptr<tos_api::validatorStats_collatedBlock> tl() const {
    ...
    std::vector<tl_object_ptr<tos_api::validatorStats_blockStats_neighborStats>> neighbors_obj;
    for (const NeighborStats& neighbor : neighbors) {
      neighbors_obj.push_back(neighbor.tl());
    }
    auto block_stats = create_tl_object<tos_api::validatorStats_blockStats>(
        create_tl_object<tos_api::validatorStats_blockStats_extMsgsStats>(ext_msgs_total, ext_msgs_filtered,
    ...
    return create_tl_object<tos_api::validatorStats_collatedBlock>(
        ...
        create_tl_object<tos_api::validatorStats_blockLimitsStatus>(
...
struct ValidationStats {
  ...
  tl_object_ptr<tos_api::validatorStats_validatedBlock> tl() const {
    return create_tl_object<tos_api::validatorStats_validatedBlock>(
...
class ValidatorManager : public ValidatorManagerInterface {
 public:
  ...
  // the incarnation `generation` it was retired at, and the exact directory name.
