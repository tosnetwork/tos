...
class Empty {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_empty>();
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_empty>();
  }
...
class Block {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_blockFile>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_blockFile>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class ZeroState {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_zeroStateFile>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_zeroStateFile>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class SplitAccountState {
 public:
  static SplitAccountState create(BlockIdExt block_id, BlockIdExt masterchain_block_id, ShardId effective_shard) {
    auto hash = create_hash_tl_object<tos_api::db_filedb_key_splitAccountStateFile>(
...
class SplitPersistentState {
 public:
  static SplitPersistentState create(BlockIdExt block_id, BlockIdExt masterchain_block_id) {
    auto hash = create_hash_tl_object<tos_api::db_filedb_key_splitPersistentStateFile>(
...
class PersistentStateShort {
 public:
  static PersistentStateShort create(BlockIdExt block_id, BlockIdExt masterchain_block_id) {
    auto hash = create_hash_tl_object<tos_api::db_filedb_key_persistentStateFile>(
        create_tl_block_id(block_id), create_tl_block_id(masterchain_block_id));
...
class PersistentState {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_persistentStateFile>(create_tl_block_id(block_id),
                                                                        create_tl_block_id(masterchain_block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_persistentStateFile>(create_tl_block_id(block_id),
                                                                             create_tl_block_id(masterchain_block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
...
class Proof {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_proof>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_proof>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class ProofLink {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_proofLink>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_proofLink>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class Signatures {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_signatures>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_signatures>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class CandidateRef {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_candidateRef>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_candidateRef>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
...
class BlockInfo {
 public:
  tl_object_ptr<tos_api::db_filedb_Key> tl() const {
    return create_tl_object<tos_api::db_filedb_key_blockInfo>(create_tl_block_id(block_id));
  }
  FileHash hash() const {
    return create_hash_tl_object<tos_api::db_filedb_key_blockInfo>(create_tl_block_id(block_id));
  }
  ShardIdFull shard() const {
    return block_id.shard_full();
  }
