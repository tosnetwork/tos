...
void QueueSizeCounter::get_queue_size_ex(tos::BlockIdExt block_id, bool calc_whole, td::Promise<td::uint64> promise) {
...
void QueueSizeCounter::on_error(tos::BlockIdExt block_id, td::Status error) {
