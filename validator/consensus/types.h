...
using overlayId = tos_api::consensus_overlayId;
using OverlayIdRef = tl_object_ptr<overlayId>;

using dataToSign = tos_api::consensus_dataToSign;
using DataToSignRef = tl_object_ptr<dataToSign>;

using candidateId = tos_api::consensus_candidateId;
using CandidateIdRef = tl_object_ptr<candidateId>;

using candidateParent = tos_api::consensus_candidateParent;
using candidateWithoutParents = tos_api::consensus_candidateWithoutParents;
using CandidateParent = tos_api::consensus_CandidateParent;
using CandidateParentRef = tl_object_ptr<CandidateParent>;

using candidateHashDataOrdinary = tos_api::consensus_candidateHashDataOrdinary;
using candidateHashDataEmpty = tos_api::consensus_candidateHashDataEmpty;
using CandidateHashData = tos_api::consensus_CandidateHashData;
using CandidateHashDataRef = tl_object_ptr<CandidateHashData>;

using block = tos_api::consensus_block;
using empty = tos_api::consensus_empty;
using CandidateData = tos_api::consensus_CandidateData;
