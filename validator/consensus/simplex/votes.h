...
using notarizeVote = tos_api::consensus_simplex_notarizeVote;
using finalizeVote = tos_api::consensus_simplex_finalizeVote;
using skipVote = tos_api::consensus_simplex_skipVote;
using UnsignedVote = tos_api::consensus_simplex_UnsignedVote;
using UnsignedVoteRef = tl_object_ptr<UnsignedVote>;

using vote = tos_api::consensus_simplex_vote;
