...
using block = tos_api::consensus_stats_block;
using empty = tos_api::consensus_stats_empty;
using CandidateBlock = tos_api::consensus_stats_CandidateBlock;
using CandidateBlockRef = tl_object_ptr<CandidateBlock>;

using id = tos_api::consensus_stats_id;
using collateStarted = tos_api::consensus_stats_collateStarted;
using collateFinished = tos_api::consensus_stats_collateFinished;
using collatedEmpty = tos_api::consensus_stats_collatedEmpty;
using candidateReceived = tos_api::consensus_stats_candidateReceived;
using validationStarted = tos_api::consensus_stats_validationStarted;
using validationFinished = tos_api::consensus_stats_validationFinished;
using blockAccepted = tos_api::consensus_stats_blockAccepted;
using Event = tos_api::consensus_stats_Event;
using EventRef = tl_object_ptr<Event>;

using timestampedEvent = tos_api::consensus_stats_timestampedEvent;
using TimestampedEventRef = tl_object_ptr<timestampedEvent>;

using events = tos_api::consensus_stats_events;
