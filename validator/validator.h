...
struct CollatorsList : public td::CntObject {
  ...
  td::Status unpack(const tos_api::engine_validator_collatorsList& obj);
...
struct ShardBlockVerifierConfig : public td::CntObject {
  ...
  td::Status unpack(const tos_api::engine_validator_shardBlockVerifierConfig& obj);
};
...
struct ValidatorManagerOptions : public td::CntObject {
 public:
  ...
  virtual bool get_state_serializer_random_delay_enabled() const = 0;
  ...
  virtual void set_celldb_cache_min_size(td::uint64 value) = 0;
  virtual td::uint64 get_celldb_cell_cache_max_size() const = 0;
  virtual void set_celldb_cell_cache_max_size(td::uint64 value) = 0;
  ...
  virtual void set_state_serializer_random_delay_enabled(bool value) = 0;
 ...
 public:
  class Callback {
   public:
    ...
    virtual void on_new_masterchain_block(td::Ref<tos::validator::MasterchainState> state,
  ...
  virtual void get_collation_manager_stats(
      td::Promise<tl_object_ptr<tos_api::engine_validator_collationManagerStats>> promise) = 0;
