...
class LiteQuery : public td::actor::Actor {
  ...
  ExtMessageIngressSource source_;
  ...
  tl_object_ptr<tos::lite_api::Function> query_obj_;
  ...
  std::vector<tos::BlockIdExt> blk_ids_;
 ...
 private:
  ...
  void abort_getTransactions(td::Status error, tos::BlockIdExt blkid);
  ...
  void perform_lookupBlockWithProof(BlockId blkid, BlockIdExt client_mc_blkid, int mode, LogicalTime lt,
                                    UnixTime utime);
  void continue_lookupBlockWithProof_getHeaderProof(Ref<tos::validator::BlockData> block,
  ...
  bool construct_proof_link_forward(tos::BlockIdExt cur, tos::BlockIdExt next);
  bool construct_proof_link_forward_cont(tos::BlockIdExt cur, tos::BlockIdExt next);
  bool construct_proof_link_back(tos::BlockIdExt cur, tos::BlockIdExt next);
  bool construct_proof_link_back_cont(tos::BlockIdExt cur, tos::BlockIdExt next);
  bool adjust_last_proof_link(tos::BlockIdExt cur, Ref<vm::Cell> block_root);
  bool finish_proof_chain(tos::BlockIdExt id);
  ...
  void load_prevKeyBlock(tos::BlockIdExt blkid, td::Promise<std::pair<BlockIdExt, Ref<BlockQ>>>);
  void continue_loadPrevKeyBlock(tos::BlockIdExt blkid, td::Result<std::pair<Ref<MasterchainState>, BlockIdExt>> res,
                                 td::Promise<std::pair<BlockIdExt, Ref<BlockQ>>>);
  void finish_loadPrevKeyBlock(tos::BlockIdExt blkid, td::Result<Ref<BlockData>> res,
