...
class MasterchainStateQ : public MasterchainState, public ShardStateQ {
 public:
  ...
  bool get_old_mc_block_id(tos::BlockSeqno seqno, tos::BlockIdExt& blkid,
                           tos::LogicalTime* end_lt = nullptr) const override;
  bool check_old_mc_block_id(const tos::BlockIdExt& blkid, bool strict = false) const override;
