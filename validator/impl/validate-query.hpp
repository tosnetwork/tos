...
class ValidateQuery : public td::actor::Actor {
  ...
  static constexpr long long supported_capabilities() {
    return capCreateStatsEnabled | capBounceMsgBody | capReportVersion | capShortDequeue | capStoreOutMsgQueueSize |
           capMsgMetadata | capDeferMessages | capFullCollatedData | capBlockTransition;
  }
 ...
 private:
  ...
  tos::Bits256 prev_state_hash_, state_hash_;
  ...
  tos::BlockSeqno mc_seqno_{0}, latest_mc_seqno_;
  ...
  tos::BlockSeqno min_shard_ref_mc_seqno_{~0U};
  tos::UnixTime max_shard_utime_{0};
  tos::LogicalTime max_shard_lt_{0};

  int global_id_{0};
  int global_version_{0};
  bool allow_same_timestamp_{false};
  tos::BlockSeqno vert_seqno_{~0U};
  bool ihr_enabled_{false};
  bool create_stats_enabled_{false};
  tos::BlockSeqno prev_key_block_seqno_;
  ...
  tos::LogicalTime proc_lt_{0}, claimed_proc_lt_{0}, min_enq_lt_{~0ULL};
  tos::Bits256 proc_hash_ = tos::Bits256::zero(), claimed_proc_hash_, min_enq_hash_;
  ...
  bool fix_one_processed_upto(block::MsgProcessedUpto& proc, tos::ShardIdFull owner, bool allow_cur = false);
  ...
  bool precheck_one_transaction(td::ConstBitPtr acc_id, tos::LogicalTime trans_lt, Ref<vm::CellSlice> trans_csr,
                                tos::Bits256& prev_trans_hash, tos::LogicalTime& prev_trans_lt,
                                unsigned& prev_trans_lt_len, tos::Bits256& acc_state_hash);
  ...
  bool update_max_processed_lt_hash(tos::LogicalTime lt, const tos::Bits256& hash);
  bool update_min_enqueued_lt_hash(tos::LogicalTime lt, const tos::Bits256& hash);
  ...
  bool check_neighbor_outbound_message(Ref<vm::CellSlice> enq_msg, tos::LogicalTime lt, td::ConstBitPtr key,
  ...
  bool check_one_prev_dict_update(tos::BlockSeqno seqno, Ref<vm::CellSlice> old_val_extra,
