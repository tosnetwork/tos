...
class ExtMessageQ : public ExtMessage {
 ...
 public:
  ...
  // Transaction phase configuration prepared from a (config, workchain, utime) tuple. Checker
  // actors reuse it across messages exactly as a collator reuses the equivalent configuration
  // across transactions in a block.
