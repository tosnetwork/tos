...
// Note, that in wasm (in tol-js), path mappings are handled in a different way, in a JS resolver.
...
struct CompilerSettings {
  ...
  bool tol_src_as_line_comments = true;
  ...
  std::string stdlib_folder;    // path to tol-stdlib/; note: from tol-js it's empty! tol-js reads files via js callback
...
// G_settings is filled by tol-main or tol-wasm before starting compilation
