...
#[test]
fn validator_auth_control_config_preserves_native_binding() {
    let source = fixture();
    for key in ["p34", "p36"] {
...
#[test]
fn validator_auth_control_config_refuses_binding_downgrade() {
...
#[test]
fn validator_auth_control_config_numeric_bounds() {
    for (field, value) in [
...
#[test]
fn validator_auth_control_config_unique_json() {
