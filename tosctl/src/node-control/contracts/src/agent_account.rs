...
mod tests {
    ...
    fn release_identifiers_are_frozen() {
        ...
        assert_eq!(
            ...
            "284e09b4b3b4f1ac7630e8a8b22e74e998351d75ad1f23afae3279089813d1c7"
        );
        assert_eq!(
            hex::encode(
            ...
            "aff84f709d3a96afe464a2e58904aaba3932c748e3815f60dde50936a9a8201c"
        );
        assert_eq!(
            AgentAccountContract::calculate_address(-1, &init).unwrap().to_string(),
            "-1:aff84f709d3a96afe464a2e58904aaba3932c748e3815f60dde50936a9a8201c"
        );
    }
