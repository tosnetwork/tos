...
impl Handlers {
    ...
    fn add_code_page_0_blockchain(&mut self) -> &mut Handlers {
        self.add_subset(
            0xFA,
            Handlers::new()
                .set(0x00, Loader::ldtomis)
                .set(0x01, Loader::ldvarint16)
                .set(0x02, Loader::sttomis)
    ...
    fn add_code_page_0_gas_rand_config(&mut self) -> &mut Handlers {
        self.add_subset(
            ...
            Handlers::new()
                ...
                .set(0x04, Loader::tomitogas)
                .set(0x05, Loader::gastotomi)
    ...
    fn add_code_page_0_crypto(&mut self) -> &mut Handlers {
        self.add_subset(
            ...
            Handlers::new()
                ...
                .set(0x17, Loader::vauth_chksign)
                .set(0x18, Loader::vauth_state)
                .set(0x19, Loader::vauth_apply)
                .set(0x1a, Loader::vauth_bind)
