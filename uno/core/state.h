...
struct UnoShardState {
    ...
    // Mining state (added per uno-mine-v1 Phase 2; see doc/uno-mine-air-constraints.md)
    uint64_t mine_remaining{0};             // 21M nano-UNO at genesis, monotonically decreases
    uint32_t mine_epoch{0};                 // cumulative successful solves (0 at genesis)
