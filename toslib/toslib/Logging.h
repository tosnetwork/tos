...
class Logging {
 public:
  static td::Status set_current_stream(toslib_api::object_ptr<toslib_api::LogStream> stream);

  static td::Result<toslib_api::object_ptr<toslib_api::LogStream>> get_current_stream();
