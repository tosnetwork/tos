...
static td::Result<std::pair<toslib_api::object_ptr<toslib_api::Function>, std::string>> to_request(td::Slice request) {
  ...
  toslib_api::object_ptr<toslib_api::Function> func;
