...
struct ToslibError {
  ...
  static td::Status LiteServer(td::int32 code, td::Slice message) {
    ...
    switch (tos::ErrorCode(code)) {
      case tos::ErrorCode::cancelled:
        return f("CANCELLED");
      case tos::ErrorCode::failure:
        return f("FAILURE");
      case tos::ErrorCode::error:
        return f("ERROR");
      case tos::ErrorCode::warning:
        return f("WARNING");
      case tos::ErrorCode::protoviolation:
        return f("PROTOVIOLATION");
      case tos::ErrorCode::timeout:
        return f("TIMEOUT");
      case tos::ErrorCode::notready:
        return f("NOTREADY");
    }
    return f("UNKNOWN");
  }
