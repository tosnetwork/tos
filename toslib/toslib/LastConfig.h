...
class LastConfig : public td::actor::Actor {
 ...
 private:
  ...
  void on_config(tos::BlockIdExt requested_block_id,
                 td::Result<tos::tos_api::object_ptr<tos::lite_api::liteServer_configInfo>> r_config);
  td::Status process_config(const tos::BlockIdExt& requested_block_id,
                            td::Result<tos::tos_api::object_ptr<tos::lite_api::liteServer_configInfo>> r_config);
  td::Status process_config_proof(const tos::BlockIdExt& requested_block_id,
                                  tos::tos_api::object_ptr<tos::lite_api::liteServer_configInfo> config);
