...
class RldpConnection {
 ...
 private:
  ...
  void receive_raw_obj(tos::tos_api::rldp2_messagePart &part);

  void receive_raw_obj(tos::tos_api::rldp2_complete &part);

  void receive_raw_obj(tos::tos_api::rldp2_confirm &part);
};
}  // namespace rldp2
}  // namespace tos
