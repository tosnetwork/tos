...
brew install ninja pkg-config automake libtool autoconf texinfo ripgrep
...
if [ "$with_artifacts" = true ]; then
  ...
  cp build/toslib/toslib-cli artifacts/
  cp build/toslib/libtoslibjson.0.5.dylib artifacts/libtoslibjson.dylib
