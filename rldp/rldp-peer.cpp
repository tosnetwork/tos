...
void RldpTransferSenderImpl::send_one_part(td::uint32 seqno) {
  ...
  auto obj = create_tl_object<tos_api::rldp_messagePart>(transfer_id_, fec_type_.tl(), part_, data_.size(), seqno,
...
void RldpTransferReceiverImpl::receive_part(fec::FecType fec_type, td::uint32 part, td::uint64 total_size,
  ...
  if (part < part_) {
    auto obj = create_tl_object<tos_api::rldp_complete>(transfer_id_, part);
    td::actor::send_closure(adnl_, &adnl::Adnl::send_message, local_id_, peer_id_, serialize_tl_object(obj, true));
    return;
  }
  if (part > part_) {
  ...
  if (decoder_->may_try_decode()) {
    ...
    if (D.is_ok()) {
      ...
      auto obj = create_tl_object<tos_api::rldp_complete>(transfer_id_, part_);
      td::actor::send_closure(adnl_, &adnl::Adnl::send_message, local_id_, peer_id_, serialize_tl_object(obj, true));
      part_++;
      cnt_ = 0;
      max_seqno_ = 0;
  ...
  if (cnt_ >= 10) {
    auto obj = create_tl_object<tos_api::rldp_confirm>(transfer_id_, part_, max_seqno_);
    td::actor::send_closure(adnl_, &adnl::Adnl::send_message, local_id_, peer_id_, serialize_tl_object(obj, true));
    cnt_ = 0;
  }
}
