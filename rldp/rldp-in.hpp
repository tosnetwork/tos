...
class RldpIn : public RldpImpl {
 public:
  ...
  void process_message_part(adnl::AdnlNodeIdShort source, adnl::AdnlNodeIdShort local_id, tos_api::rldp_confirm &part);
  void process_message_part(adnl::AdnlNodeIdShort source, adnl::AdnlNodeIdShort local_id, tos_api::rldp_complete &part);
