...
tos::tl_object_ptr<tos::tos_api::engine_validator_config> Config::tl() const {
  ...
  return tos::create_tl_object<tos::tos_api::engine_validator_config>(
      ...
      tos::PublicKeyHash::zero().tl(), std::move(full_node_slaves_vec), std::move(full_node_masters_vec), nullptr,
...
void DhtServer::deleted_key(tos::PublicKeyHash x) {
...
td::Status DhtServer::load_global_config() {
  ...
  //if (conf.adnl_) {
  //  td::actor::send_closure(adnl_, &tos::adnl::Adnl::add_static_nodes_from_config,
...
td::Promise<tos::PublicKey> DhtServer::get_key_promise(td::MultiPromise::InitGuard &ig) {
  auto P = td::PromiseCreator::lambda(
...
void DhtServer::got_key(tos::PublicKey key) {
...
void DhtServer::add_adnl(tos::PublicKeyHash id, AdnlCategory cat) {
...
void DhtServer::start_dht() {
  for (auto &dht : config_.dht_ids) {
    auto D = tos::dht::Dht::create(tos::adnl::AdnlNodeIdShort{dht}, db_root_, dht_config_, keyring_.get(), adnl_.get());
    D.ensure();
...
void DhtServer::start_control_interface() {
  ...
  for (auto &s : config_.controls) {
    td::actor::send_closure(adnl_, &tos::adnl::Adnl::add_id, tos::adnl::AdnlNodeIdFull{keys_[s.second.key]},
                            tos::adnl::AdnlAddressList{}, static_cast<td::uint8>(255));
    td::actor::send_closure(adnl_, &tos::adnl::Adnl::subscribe, tos::adnl::AdnlNodeIdShort{s.second.key},
                            std::string(""), std::make_unique<Callback>(actor_id(this)));

    c_ids.push_back(tos::adnl::AdnlNodeIdShort{s.second.key});
...
void DhtServer::started_control_interface(td::actor::ActorOwn<tos::adnl::AdnlExtServer> control_ext_server) {
...
void DhtServer::add_adnl_node(tos::PublicKey key, AdnlCategory cat, td::Promise<td::Unit> promise) {
  ...
  if (!adnl_.empty()) {
    td::actor::send_closure(adnl_, &tos::adnl::Adnl::add_id, tos::adnl::AdnlNodeIdFull{key}, addr_lists_[cat], cat);
  }

  write_config(std::move(promise));
}

void DhtServer::add_dht_node(tos::PublicKeyHash key_hash, td::Promise<td::Unit> promise) {
  ...
  if (dht_nodes_.size() > 0) {
    auto D =
        tos::dht::Dht::create(tos::adnl::AdnlNodeIdShort{key_hash}, db_root_, dht_config_, keyring_.get(), adnl_.get());
    D.ensure();
...
void DhtServer::add_control_interface(tos::PublicKeyHash id, td::int32 port, td::Promise<td::Unit> promise) {
  ...
  td::actor::send_closure(control_ext_server_, &tos::adnl::AdnlExtServer::add_tcp_port, static_cast<td::uint16>(port));

  write_config(std::move(promise));
}

void DhtServer::add_control_process(tos::PublicKeyHash id, td::int32 port, tos::PublicKeyHash pub,
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_getTime &query, td::BufferSlice data,
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_importPrivateKey &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_default)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_exportPrivateKey &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_exportPublicKey &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_default)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_generateKeyPair &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_default)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_addAdnlId &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  ...
  auto P = td::PromiseCreator::lambda(
      [SelfId = actor_id(this), cat, promise = std::move(promise)](td::Result<tos::PublicKey> R) mutable {
        if (R.is_error()) {
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_addDhtId &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
  ...
  auto P = td::PromiseCreator::lambda([SelfId = actor_id(this), key_hash = tos::PublicKeyHash{query.key_hash_},
  ...
  td::actor::send_closure(keyring_, &tos::keyring::Keyring::check_key, tos::PublicKeyHash{query.key_hash_},
                          std::move(P));
}

void DhtServer::run_control_query(tos::tos_api::engine_validator_getConfig &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_default)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
...
void DhtServer::run_control_query(tos::tos_api::engine_validator_sign &query, td::BufferSlice data,
                                  tos::PublicKeyHash src, td::uint32 perm, td::Promise<td::BufferSlice> promise) {
  if (!(perm & DhtServerPermissions::vep_unsafe)) {
    promise.set_value(create_control_query_error(td::Status::Error(tos::ErrorCode::error, "not authorized")));
    return;
...
void DhtServer::process_control_query(tos::adnl::AdnlNodeIdShort src, tos::adnl::AdnlNodeIdShort dst,
  ...
  if (it == control_permissions_.end()) {
    promise.set_error(td::Status::Error(tos::ErrorCode::protoviolation, "forbidden"));
    return;
  }

  tos::tos_api::downcast_call(*f.get(), [&](auto &obj) {
...
int main(int argc, char *argv[]) {
  ...
  td::OptionParser p;
  p.set_description("dht server for TOS DHT network");
