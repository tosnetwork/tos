...
class AdnlLocalId : public td::actor::Actor {
 public:
  ...
  void get_stats(bool all, td::Promise<tl_object_ptr<tos_api::adnl_stats_localId>> promise);
 ...
 private:
  ...
  struct PacketStats {
    ...
    tl_object_ptr<tos_api::adnl_stats_localIdPackets> tl(bool all = true) const;
