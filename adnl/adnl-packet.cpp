...
td::Result<AdnlPacket> AdnlPacket::create(tl_object_ptr<tos_api::adnl_packetContents> packet) {
  AdnlPacket R;
...
tl_object_ptr<tos_api::adnl_packetContents> AdnlPacket::tl() const {
  return create_tl_object<tos_api::adnl_packetContents>(
