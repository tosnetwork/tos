...
class TestLoopbackNetworkManager : public tos::adnl::AdnlNetworkManager {
 public:
  ...
  void send_udp_packet(tos::adnl::AdnlNodeIdShort src_id, tos::adnl::AdnlNodeIdShort dst_id, td::IPAddress dst_addr,
