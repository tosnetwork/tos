...
class AdnlNodeIdShort {
 public:
  ...
  explicit AdnlNodeIdShort(tl_object_ptr<tos_api::adnl_id_short> &&obj) : hash_(obj->id_) {
  }
  explicit AdnlNodeIdShort(const tl_object_ptr<tos_api::adnl_id_short> &obj) : hash_(obj->id_) {
  }
  ...
  tl_object_ptr<tos_api::adnl_id_short> tl() const {
    return create_tl_object<tos_api::adnl_id_short>(hash_.tl());
  }
  auto as_slice() {
...
class AdnlNodeIdFull {
 private:
  explicit AdnlNodeIdFull(const tl_object_ptr<tos_api::PublicKey> &pub) : pub_(pub) {
  }
 ...
 public:
  ...
  static td::Result<AdnlNodeIdFull> create(const tl_object_ptr<tos_api::PublicKey> &pub) {
...
inline StringBuilder &operator<<(StringBuilder &stream, const tos::adnl::AdnlNodeIdShort &value) {
