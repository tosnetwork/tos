...
class AdnlAddressImpl : public td::CntObject {
 public:
  ...
  virtual tl_object_ptr<tos_api::adnl_Address> tl() const = 0;
...
class AdnlAddressList {
 private:
  AdnlAddressList(const tl_object_ptr<tos_api::adnl_addressList> &addrs);
 ...
 public:
  ...
  tl_object_ptr<tos_api::adnl_addressList> tl() const;
  AdnlAddressList() : version_{-1}, reinit_date_{0}, priority_{0}, expire_at_{0} {
  }

  static td::Result<AdnlAddressList> create(const tl_object_ptr<tos_api::adnl_addressList> &addr_list);
