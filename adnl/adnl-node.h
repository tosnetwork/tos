...
class AdnlNode {
 ...
 public:
  ...
  static td::Result<AdnlNode> create(const tl_object_ptr<tos_api::adnl_node>& obj);

  tl_object_ptr<tos_api::adnl_node> tl() const {
    return create_tl_object<tos_api::adnl_node>(pub_.tl(), addr_list_.tl());
  }
...
class AdnlNodesList {
 ...
 public:
  ...
  tl_object_ptr<tos_api::adnl_nodes> tl() const;
  static td::Result<AdnlNodesList> create(const tl_object_ptr<tos_api::adnl_nodes>& nodes);
};
