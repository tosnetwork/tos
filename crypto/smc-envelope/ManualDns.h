...
class DnsInterface {
 public:
  ...
  struct EntryData {
    ...
    static EntryData adnl_address(tos::Bits256 adnl_address) {
    ...
    static EntryData storage_address(tos::Bits256 bag_id) {
...
class ManualDns : public tos::SmartContract, public DnsInterface {
 public:
