...
std::vector<tos::ValidatorDescr> ValidatorSet::export_vector() const {
  return ids_;
}
...
Ref<ValidatorSet> ValidatorSetCompute::compute_validator_set(tos::ShardIdFull shard, const TotalValidatorSet &vset,
...
Ref<ValidatorSet> ValidatorSetCompute::get_validator_set(tos::ShardIdFull shard, tos::UnixTime utime,
...
Ref<ValidatorSet> ValidatorSetCompute::get_next_validator_set(tos::ShardIdFull shard, tos::UnixTime utime,
                                                              tos::CatchainSeqno cc) const {
  if (!config_ || !cur_validators_) {
