...
tos::LogicalTime OutputQueueMerger::MsgKeyValue::get_node_lt(Ref<vm::Cell> node, int key_pfx_len) {
...
OutputQueueMerger::OutputQueueMerger(tos::ShardIdFull queue_for, std::vector<OutputQueueMerger::Neighbor> neighbors)
