...
struct MsgAddressInt final : TLB_Complex {
  ...
  static tos::AccountIdPrefixFull get_prefix(vm::CellSlice&& cs);
  static tos::AccountIdPrefixFull get_prefix(const vm::CellSlice& cs);
  static tos::AccountIdPrefixFull get_prefix(Ref<vm::CellSlice> cs_ref);
  static bool get_prefix_to(vm::CellSlice&& cs, tos::AccountIdPrefixFull& pfx) {
    return (pfx = get_prefix(std::move(cs))).is_valid();
  }
  static bool get_prefix_to(const vm::CellSlice& cs, tos::AccountIdPrefixFull& pfx) {
    return (pfx = get_prefix(cs)).is_valid();
  }
  static bool get_prefix_to(Ref<vm::CellSlice> cs_ref, tos::AccountIdPrefixFull& pfx) {
    return cs_ref.not_null() && (pfx = get_prefix(std::move(cs_ref))).is_valid();
  }
  bool skip_get_depth(vm::CellSlice& cs, int& depth) const;
  bool extract_std_address(Ref<vm::CellSlice> cs_ref, tos::WorkchainId& workchain, tos::StdSmcAddress& addr,
                           bool rewrite = true) const;
  bool extract_std_address(vm::CellSlice& cs, tos::WorkchainId& workchain, tos::StdSmcAddress& addr,
                           bool rewrite = true) const;
  ...
  bool store_std_address(vm::CellBuilder& cb, tos::WorkchainId workchain, const tos::StdSmcAddress& addr) const;
  Ref<vm::CellSlice> pack_std_address(tos::WorkchainId workchain, const tos::StdSmcAddress& addr) const;
...
struct MsgEnvelope final : TLB_Complex {
  ...
  struct Record_std {
    ...
    Ref<vm::Cell> msg;
    td::optional<tos::LogicalTime> emitted_lt;
...
struct ExtBlkRef final : TLB {
  ...
  bool unpack(vm::CellSlice& cs, tos::BlockIdExt& blkid, tos::LogicalTime* end_lt = nullptr) const;
  bool unpack(Ref<vm::CellSlice> cs_ref, tos::BlockIdExt& blkid, tos::LogicalTime* end_lt = nullptr) const;
  bool store(vm::CellBuilder& cb, const tos::BlockIdExt& blkid, tos::LogicalTime end_lt) const;
  Ref<vm::Cell> pack_cell(const tos::BlockIdExt& blkid, tos::LogicalTime end_lt) const;
  bool pack_to(Ref<vm::Cell>& cell, const tos::BlockIdExt& blkid, tos::LogicalTime end_lt) const;
};
...
struct ShardIdent final : TLB_Complex {
  ...
  bool unpack(vm::CellSlice& cs, tos::ShardIdFull& data) const;
  bool pack(vm::CellBuilder& cb, tos::ShardIdFull data) const;
  bool unpack(vm::CellSlice& cs, tos::WorkchainId& workchain, tos::ShardId& shard) const;
  bool pack(vm::CellBuilder& cb, tos::WorkchainId workchain, tos::ShardId shard) const;
};
...
struct ShardIdent::Record {
  ...
  Record() : shard_pfx_bits(-1), workchain_id(tos::workchainInvalid), shard_prefix(0) {
  }
...
struct BlockIdExt final : TLB_Complex {
  ...
  bool validate_skip(int* ops, vm::CellSlice& cs, bool weak = false) const override;
  bool unpack(vm::CellSlice& cs, tos::BlockIdExt& data) const;
  bool pack(vm::CellBuilder& cb, const tos::BlockIdExt& data) const;
};
