...
td::Ref<vm::Cell> load_block(std::string filename, tos::BlockIdExt& id) {
...
bool save_block(std::string filename, Ref<vm::Cell> root, tos::BlockIdExt& id) {
...
Ref<vm::Cell> adjust_block(Ref<vm::Cell> root, int vseqno_incr, const tos::BlockIdExt& id) {
  std::vector<tos::BlockIdExt> prev;
  tos::BlockIdExt mc_blkid;
  bool after_split;
