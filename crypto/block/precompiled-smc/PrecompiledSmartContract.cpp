...
Result PrecompiledSmartContract::run(td::Ref<vm::CellSlice> my_address, tos::UnixTime now, tos::LogicalTime cur_lt,
...
td::RefInt256 PrecompiledSmartContract::get_compute_fee(tos::WorkchainId wc, td::uint64 gas_used) {
  if (gas_used >= (1ULL << 63)) {
...
td::RefInt256 PrecompiledSmartContract::get_forward_fee(tos::WorkchainId wc, td::uint64 bits, td::uint64 cells) {
...
td::RefInt256 PrecompiledSmartContract::get_storage_fee(tos::WorkchainId wc, td::uint64 duration, td::uint64 bits,
                                                        td::uint64 cells) {
...
td::RefInt256 PrecompiledSmartContract::get_simple_compute_fee(tos::WorkchainId wc, td::uint64 gas_used) {
  if (gas_used >= (1ULL << 63)) {
    throw VmError{Excno::range_chk};
  }
  block::GasLimitsPrices prices = util::get_gas_prices(unpacked_config_, wc);
...
td::RefInt256 PrecompiledSmartContract::get_simple_forward_fee(tos::WorkchainId wc, td::uint64 bits, td::uint64 cells) {
  if (bits >= (1ULL << 63) || cells >= (1ULL << 63)) {
    throw VmError{Excno::range_chk};
  }
  block::MsgPrices prices = util::get_msg_prices(unpacked_config_, wc);
...
td::RefInt256 PrecompiledSmartContract::get_original_fwd_fee(tos::WorkchainId wc, const td::RefInt256 &x) {
  if (x->sgn() < 0) {
