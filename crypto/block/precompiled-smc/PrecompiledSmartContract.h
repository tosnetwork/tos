...
class PrecompiledSmartContract {
 public:
  ...
  Result run(td::Ref<vm::CellSlice> my_address, tos::UnixTime now, tos::LogicalTime cur_lt, CurrencyCollection balance,
 ...
 protected:
  ...
  td::RefInt256 get_compute_fee(tos::WorkchainId wc, td::uint64 gas_used);
  td::RefInt256 get_forward_fee(tos::WorkchainId wc, td::uint64 bits, td::uint64 cells);
  td::RefInt256 get_storage_fee(tos::WorkchainId wc, td::uint64 duration, td::uint64 bits, td::uint64 cells);
  td::RefInt256 get_simple_compute_fee(tos::WorkchainId wc, td::uint64 gas_used);
  td::RefInt256 get_simple_forward_fee(tos::WorkchainId wc, td::uint64 bits, td::uint64 cells);
  td::RefInt256 get_original_fwd_fee(tos::WorkchainId wc, const td::RefInt256& x);
