...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='uno-d78-independent-') as directory:
        root = Path(directory)
        ...
        run('restored', 0)
        print('PINNED_D78_REVIEW_PASS: static/dense-matrix checks only; no proof or host execution')
