...
TEST(RegistrationProof, RustPossessionVectorAndHostBinding) {
  ...
  block::WorkchainRegistrationPolicy policy{a.global_id, a.genesis_hash, fill(7), a.bindings, 1, 1, 2, 10};
  ...
  encoded = td::hex_decode("b4262c4f436f97163b68860a20fda0f8b34b8baa176bb5e1f44a5c85b1785c6f"
                           "ea66dee8f36b8d8b1ed8a30ac39bc1d37fabf0d6e8806f774eca2949dd09fd04");
  ASSERT_TRUE(encoded.is_ok());
  std::copy(encoded.ok().begin(), encoded.ok().end(), proof.begin());
