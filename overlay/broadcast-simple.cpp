...
static Overlay::BroadcastHash compute_broadcast_id(PublicKeyHash source, Overlay::BroadcastDataHash data_hash,
                                                   td::uint32 flags) {
  auto obj = create_tl_object<tos_api::overlay_broadcast_id>(
...
td::BufferSlice BroadcastSimple::serialize() {
  return create_serialize_tl_object<tos_api::overlay_broadcast>(
...
td::BufferSlice BroadcastSimple::to_sign() {
  return create_serialize_tl_object<tos_api::overlay_broadcast_toSign>(broadcast_hash_, date_);
}
...
td::Status BroadcastsSimple::process_broadcast(OverlayImpl *overlay, adnl::AdnlNodeIdShort src_peer_id,
                                               tl_object_ptr<tos_api::overlay_broadcast> broadcast) {
...
void BroadcastsSimple::process_query(adnl::AdnlNodeIdShort src, tos_api::overlay_getBroadcast &query,
