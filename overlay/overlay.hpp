...
//using OverlayNode = tl_object_ptr<tos_api::overlay_node>;
//using OverlayNodesList = tl_object_ptr<tos_api::overlay_nodes>;
...
struct TrafficStats {
  ...
  tl_object_ptr<tos_api::engine_validator_overlayStatsTraffic> tl() const;
};
...
struct BroadcastsLimiter {
  ...
  tl_object_ptr<tos_api::engine_validator_overlayStatsBroadcasts> tl(PublicKeyHash src,
...
class OverlayImpl : public Overlay {
 public:
  ...
  void receive_message(adnl::AdnlNodeIdShort src, tl_object_ptr<tos_api::overlay_messageExtra> extra,
                       td::BufferSlice data) override;
  void receive_query(adnl::AdnlNodeIdShort src, tl_object_ptr<tos_api::overlay_messageExtra> extra,
  ...
  void get_stats(td::Promise<tl_object_ptr<tos_api::engine_validator_overlayStats>> promise) override;
  ...
  bool check_src_peer(const adnl::AdnlNodeIdShort &id, const tos_api::overlay_MemberCertificate *certificate);
 ...
 private:
  ...
  void process_query(adnl::AdnlNodeIdShort src, tos_api::overlay_getBroadcast &query,
                     td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::overlay_getBroadcastList &query,
                     td::Promise<td::BufferSlice> promise);
  void process_query(adnl::AdnlNodeIdShort src, tos_api::overlay_repairPlumtreePart &query,
                     td::Promise<td::BufferSlice> promise);
  //void process_query(adnl::AdnlNodeIdShort src, adnl::AdnlQueryId query_id, tos_api::overlay_customQuery &query);

  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from,
                                      tl_object_ptr<tos_api::overlay_broadcast> bcast);
  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from,
                                      tl_object_ptr<tos_api::overlay_broadcastFec> bcast);
  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from,
                                      tl_object_ptr<tos_api::overlay_broadcastFecShort> bcast);
  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from,
  ...
  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from, tl_object_ptr<tos_api::overlay_unicast> msg);
  td::actor::Task<> process_broadcast(adnl::AdnlNodeIdShort message_from,
  ...
  td::Status validate_peer_certificate(const adnl::AdnlNodeIdShort &node, const OverlayMemberCertificate *cert);
  td::Status validate_peer_certificate(const adnl::AdnlNodeIdShort &node, tos_api::overlay_MemberCertificate *cert);
...
inline td::StringBuilder &operator<<(td::StringBuilder &sb, const tos::overlay::OverlayImpl::PrintId &id) {
  sb << "[overlay " << id.overlay_id << "@" << id.local_id << "]";
  return sb;
}

inline td::StringBuilder &operator<<(td::StringBuilder &sb, const tos::overlay::OverlayImpl &overlay) {
  sb << overlay.print_id();
  return sb;
}
