...
class OverlayImpl : public Overlay {
 ...
 private:
  ...
  void add_peers(const tl_object_ptr<tos_api::overlay_nodes> &nodes, bool received_from_peer = false);
  void add_peers(const tl_object_ptr<tos_api::overlay_nodesV2> &nodes, bool received_from_peer = false);
  void del_some_peers();
