...
void BroadcastsTwostep::send(OverlayImpl *overlay, PublicKeyHash send_as, td::BufferSlice data, td::BufferSlice extra,
  ...
  if (use_fec) {
    ...
    broadcast_id = get_tl_object_sha_bits256(create_tl_object<tos_api::overlay_broadcastTwostep_id>(
    ...
    for (size_t i = 0; i < other_nodes.size(); i++) {
      ...
      td::BufferSlice to_sign = create_serialize_tl_object<tos_api::overlay_broadcastTwostepFec_toSign>(
    ...
    td::BufferSlice to_sign =
        create_serialize_tl_object<tos_api::overlay_broadcastTwostepSimple_toSign>(broadcast_id, data.clone());
...
void BroadcastsTwostep::signed_simple(OverlayImpl *overlay, BroadcastTwostepDataSimple &&data,
  ...
  td::BufferSlice broadcast = create_serialize_tl_object<tos_api::overlay_broadcastTwostepSimple>(
...
void BroadcastsTwostep::signed_fec(OverlayImpl *overlay, BroadcastTwostepDataFec &&data,
  ...
  auto cert = overlay->get_certificate(data.src.pubkey_hash());
  td::BufferSlice broadcast = create_serialize_tl_object<tos_api::overlay_broadcastTwostepFec>(
      data.flags, data.date, V.second.tl(), overlay->local_id().bits256_value(),
...
td::actor::Task<> BroadcastsTwostep::process_broadcast(
  ...
  td::Bits256 broadcast_id = get_tl_object_sha_bits256(create_tl_object<tos_api::overlay_broadcastTwostep_id>(
  ...
  td::BufferSlice to_sign = create_serialize_tl_object<tos_api::overlay_broadcastTwostepSimple_toSign>(
